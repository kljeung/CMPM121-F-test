...
function Fc() {
  const i = {
        ...
        return (
          this.enabled === !1 ||
            ...
            this.spaces[a].transfer === Ke &&
              ((r.r = oi(r.r)), (r.g = oi(r.g)), (r.b = oi(r.b)))),
          r
        );
      },
      ...
      getTransfer: function (r) {
        return r === Sn ? cr : this.spaces[r].transfer;
      },
  ...
  static sRGBToLinear(e) {
    if (
      ...
      const r = n.getImageData(0, 0, e.width, e.height),
        s = r.data;
      for (let a = 0; a < s.length; a++) s[a] = hn(s[a] / 255) * 255;
      ...
      return (
        y > A && y > P
          ? y < 0.01
            ...
            : ((n = Math.sqrt(y)), (r = E / n), (s = C / n))
          : A > P
            ? A < 0.01
              ? ((n = 0.707106781), (r = 0), (s = 0.707106781))
              : ((r = Math.sqrt(A)), (n = E / r), (s = O / r))
            : P < 0.01
              ? ((n = 0.707106781), (r = 0.707106781), (s = 0))
              : ((s = Math.sqrt(P)), (n = C / s), (r = O / s)),
        this.set(n, r, s, t),
        this
      );
    }
...
class Pi {
  ...
  intersectsTriangle(e) {
    ...
    (this.getCenter(_i),
      Ni.subVectors(this.max, _i),
      Xn.subVectors(e.a, _i),
      qn.subVectors(e.b, _i),
      Yn.subVectors(e.c, _i),
      pn.subVectors(qn, Xn),
      mn.subVectors(Yn, qn),
      wn.subVectors(Xn, Yn));
    let t = [
    ...
    return !Tr(t, Xn, qn, Yn, Ni) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Tr(t, Xn, qn, Yn, Ni))
      ? !1
      : (Fi.crossVectors(pn, mn),
        (t = [Fi.x, Fi.y, Fi.z]),
        Tr(t, Xn, qn, Yn, Ni));
  }
  clampPoint(e, t) {
      ...
      : this.isEmpty()
        ...
        : (this.center.equals(e.center) === !0
            ...
            : (Ar.subVectors(e.center, this.center).setLength(e.radius),
              this.expandByPoint(gi.copy(e.center).add(Ar)),
              this.expandByPoint(gi.copy(e.center).sub(Ar))),
          this);
  }
  equals(e) {
...
class _o {
  ...
  distanceSqToSegment(e, t, n, r) {
    ...
    return (
      ...
      r && r.copy(Rr).addScaledVector(Oi, f),
      m
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, r, s) {
    (wr.subVectors(t, e), Bi.subVectors(n, e), Cr.crossVectors(wr, Bi));
    ...
    const l = o * this.direction.dot(Bi.crossVectors(xn, Bi));
    if (l < 0) return null;
    const c = o * this.direction.dot(wr.cross(xn));
...
class dt {
  ...
  extractRotation(e) {
    const t = this.elements,
      ...
      s = 1 / Kn.setFromMatrixColumn(e, 1).length(),
  ...
  lookAt(e, t, n) {
    ...
    return (
      ...
      Ct.normalize(),
      _n.crossVectors(n, Ct),
      _n.lengthSq() === 0 &&
        (Math.abs(n.z) === 1 ? (Ct.x += 1e-4) : (Ct.z += 1e-4),
        Ct.normalize(),
        _n.crossVectors(n, Ct)),
      _n.normalize(),
      zi.crossVectors(Ct, _n),
      (r[0] = _n.x),
      (r[4] = zi.x),
      (r[8] = Ct.x),
      (r[1] = _n.y),
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      (s[0] = a * E + o * v + l * k + c * H),
      (s[4] = a * C + o * D + l * K + c * te),
      (s[8] = a * O + o * B + l * q + c * se),
      (s[12] = a * S + o * V + l * ne + c * Se),
      (s[1] = u * E + d * v + f * k + m * H),
      (s[5] = u * C + d * D + f * K + m * te),
      (s[9] = u * O + d * B + f * q + m * se),
      (s[13] = u * S + d * V + f * ne + m * Se),
      (s[2] = g * E + M * v + p * k + h * H),
      (s[6] = g * C + M * D + p * K + h * te),
      (s[10] = g * O + M * B + p * q + h * se),
      (s[14] = g * S + M * V + p * ne + h * Se),
      (s[3] = T * E + y * v + A * k + P * H),
      (s[7] = T * C + y * D + A * K + P * te),
      (s[11] = T * O + y * B + A * q + P * se),
      (s[15] = T * S + y * V + A * ne + P * Se),
      this
    );
  }
  multiplyScalar(e) {
  ...
  invert() {
    const e = this.elements,
      ...
      y = g * f * c - u * p * c - g * l * m + a * p * m + u * l * h - a * f * h,
      A = u * M * c - g * d * c + g * o * m - a * M * m - u * o * h + a * d * h,
      P = g * d * l - u * M * l - g * o * f + a * M * f + u * o * p - a * d * p,
      E = t * T + n * y + r * A + s * P;
    if (E === 0)
  ...
  makePerspective(e, t, n, r, s, a, o = Kt, l = !1) {
    ...
    else if (o === lr) ((g = -a / (a - s)), (M = (-a * s) / (a - s)));
    else
      throw new Error(
...
class Lt extends Gn {
  ...
  lookAt(e, t, n) {
    ...
    (this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? Qt.lookAt(vi, Vi, this.up)
        : Qt.lookAt(Vi, vi, this.up),
      this.quaternion.setFromRotationMatrix(Qt),
      r &&
        (Qt.extractRotation(r.matrixWorld),
        Zn.setFromRotationMatrix(Qt),
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(vi, e, qc),
      e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(vi, Yc, e),
      e
    );
  }
  getWorldDirection(e) {
...
class Wt {
  ...
  static getBarycoord(e, t, n, r, s) {
    (kt.subVectors(r, t), en.subVectors(n, t), Dr.subVectors(e, t));
    const a = kt.dot(kt),
      o = kt.dot(en),
      l = kt.dot(Dr),
      c = en.dot(en),
  ...
  static containsPoint(e, t, n, r) {
    return this.getBarycoord(e, t, n, r, tn) === null
      ? !1
  ...
  static getInterpolatedAttribute(e, t, n, r, s, a) {
    return (
      ...
      Or.fromBufferAttribute(e, r),
      a.setScalar(0),
      a.addScaledVector(Nr, s.x),
      a.addScaledVector(Fr, s.y),
      a.addScaledVector(Or, s.z),
      a
    );
  }
  ...
  closestPointToPoint(e, t) {
    const n = this.a,
      ...
      s = this.c;
    let a, o;
    ($n.subVectors(r, n), Jn.subVectors(s, n), Lr.subVectors(e, n));
    const l = $n.dot(Lr),
      c = Jn.dot(Lr);
    ...
    return (
      (a = M * h),
      (o = f * h),
      t.copy(n).addScaledVector($n, a).addScaledVector(Jn, o)
    );
  }
  equals(e) {
...
class je {
  ...
  setHSL(e, t, n, r = We.workingColorSpace) {
    if (((e = Ic(e, 1)), (t = Oe(t, 0, 1)), (n = Oe(n, 0, 1)), t === 0))
...
class dr extends Gn {
  ...
  toJSON(e) {
    ...
    ((n.uuid = this.uuid),
      ...
      this.blendSrc !== Zr && (n.blendSrc = this.blendSrc),
...
class Tn extends Gn {
        ...
        for (let n = 0, r = t.length; n < r; n++) {
          ...
          (Pt.setFromBufferAttribute(s),
            this.morphTargetsRelative
              ? (mt.addVectors(this.boundingBox.min, Pt.min),
                this.boundingBox.expandByPoint(mt),
                mt.addVectors(this.boundingBox.max, Pt.max),
                this.boundingBox.expandByPoint(mt))
      ...
      if ((Pt.setFromBufferAttribute(e), t))
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          (Mi.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (mt.addVectors(Pt.min, Mi.min),
                Pt.expandByPoint(mt),
                mt.addVectors(Pt.max, Mi.max),
                Pt.expandByPoint(mt))
              : (Pt.expandByPoint(Mi.min), Pt.expandByPoint(Mi.max)));
        }
      Pt.getCenter(n);
      let r = 0;
        ...
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          for (let c = 0, u = o.count; c < u; c++)
            (mt.fromBufferAttribute(o, c),
              l && (Qn.fromBufferAttribute(e, c), mt.add(Qn)),
              (r = Math.max(r, n.distanceToSquared(mt))));
        }
  ...
  computeTangents() {
    ...
    const a = this.getAttribute("tangent"),
      o = [],
      l = [];
    for (let O = 0; O < n.count; O++) ((o[O] = new F()), (l[O] = new F()));
    const c = new F(),
      u = new F(),
      d = new F(),
      f = new Ne(),
      ...
      p = new F();
    function h(O, S, v) {
      (c.fromBufferAttribute(n, O),
        u.fromBufferAttribute(n, S),
        d.fromBufferAttribute(n, v),
        f.fromBufferAttribute(s, O),
    ...
    const y = new F(),
      ...
      E = new F();
    function C(O) {
      (P.fromBufferAttribute(r, O), E.copy(P));
      const S = o[O];
      (y.copy(S),
        y.sub(P.multiplyScalar(P.dot(S))).normalize(),
        A.crossVectors(E, S));
      const D = A.dot(l[O]) < 0 ? -1 : 1;
      a.setXYZW(O, y.x, y.y, y.z, D);
    }
    for (let O = 0, S = T.length; O < S; ++O) {
      const v = T[O],
        D = v.start,
...
class Bt extends Lt {
    ...
    if (s && o) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const u = o[l],
          d = s[l];
        u !== 0 &&
          (Vr.fromBufferAttribute(d, e),
          a ? Yi.addScaledVector(Vr, u) : Yi.addScaledVector(Vr.sub(t), u));
      }
      t.add(Yi);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    r !== void 0 &&
      ...
      !(
        ki.containsPoint(Pn.origin) === !1 &&
        (Pn.intersectSphere(ki, ya) === null ||
          Pn.origin.distanceToSquared(ya) > (e.far - e.near) ** 2)
      ) &&
        (Ea.copy(s).invert(),
        Pn.copy(e.ray).applyMatrix4(Ea),
    ...
    if (o !== null)
      if (Array.isArray(a))
        for (let g = 0, M = f.length; g < M; g++) {
          ...
          for (let A = T, P = y; A < P; A += 3) {
            const E = o.getX(A),
              C = o.getX(A + 1),
              O = o.getX(A + 2);
            ((r = Zi(this, h, e, n, c, u, d, E, C, O)),
              r &&
...
function Jc(i, e, t, n, r, s, a, o) {
  ...
  return c < t.near || c > t.far
    ? null
    : { distance: c, point: Ki.clone(), object: i };
}
function Zi(i, e, t, n, r, s, a, o, l, c) {
  (i.getVertexPosition(o, Wi),
    i.getVertexPosition(l, Xi),
    i.getVertexPosition(c, qi));
  const u = Jc(i, e, t, n, Wi, Xi, qi, Ta);
  if (u) {
    const d = new F();
    (Wt.getBarycoord(Ta, Wi, Xi, qi, d),
      r && (u.uv = Wt.getInterpolatedAttribute(r, o, l, c, d, new Ne())),
      s && (u.uv1 = Wt.getInterpolatedAttribute(s, o, l, c, d, new Ne())),
      a &&
        ((u.normal = Wt.getInterpolatedAttribute(a, o, l, c, d, new F())),
        u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1)));
    const f = { a: o, b: l, c, normal: new F(), materialIndex: 0 };
    (Wt.getNormal(Wi, Xi, qi, f.normal), (u.face = f), (u.barycoord = d));
  }
  return u;
}
class cn extends Tn {
  constructor(e = 1, t = 1, n = 1, r = 1, s = 1, a = 1) {
    ...
    function g(M, p, h, T, y, A, P, E, C, O, S) {
      const v = A / C,
        D = P / O,
        B = A / 2,
        V = P / 2,
      ...
      for (let se = 0; se < O; se++)
        for (let Se = 0; Se < C; Se++) {
          const He = f + Se + K * se,
            ...
            Je = f + (Se + 1) + K * (se + 1),
            Qe = f + (Se + 1) + K * se;
          (l.push(He, Xe, Qe), l.push(Xe, Je, Qe), (H += 6));
        }
      (o.addGroup(m, H, S), (m += H), (f += ne));
    }
  }
  copy(e) {
    return (
...
class Ft extends Eo {
  ...
  getEffectiveFOV() {
    return Fs * 2 * Math.atan(Math.tan(ar * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  getViewSize(e, t) {
    return (this.getViewBounds(e, Aa, Ra), t.subVectors(Ra, Aa));
  }
  ...
  updateProjectionMatrix() {
    const e = this.near;
    let t = (e * Math.tan(ar * 0.5 * this.fov)) / this.zoom,
      n = 2 * t,
      r = this.aspect * n,
      s = -0.5 * r;
    const a = this.view;
...
class il extends Lt {
  constructor(e, t, n) {
    ...
    const r = new Ft(ei, ti, e, t);
    ((r.layers = this.layers), this.add(r));
    const s = new Ft(ei, ti, e, t);
    ((s.layers = this.layers), this.add(s));
    const a = new Ft(ei, ti, e, t);
    ((a.layers = this.layers), this.add(a));
    const o = new Ft(ei, ti, e, t);
    ((o.layers = this.layers), this.add(o));
    const l = new Ft(ei, ti, e, t);
    ((l.layers = this.layers), this.add(l));
    const c = new Ft(ei, ti, e, t);
...
class yo extends St {
  constructor(e = [], t = li, n, r, s, a, o, l, c, u) {
...
class rl extends Vn {
  ...
  fromEquirectangularTexture(e, t) {
    ...
    const a = new Bt(r, s),
      o = t.minFilter;
    return (
      t.minFilter === Fn && (t.minFilter = Ot),
      new il(1, 10, this).update(e, a),
      (t.minFilter = o),
      a.geometry.dispose(),
      a.material.dispose(),
      this
...
class ol extends St {
  constructor(e = null, t = 1, n = 1, r, s, a, o, l, c = Dt, u = Dt, d, f) {
...
class Mn {
  ...
  setFromCoplanarPoints(e, t, n) {
    const r = Hr.subVectors(n, t).cross(cl.subVectors(e, t)).normalize();
...
class To {
  ...
  setFromProjectionMatrix(e, t = Kt, n = !1) {
    const r = this.planes,
      ...
      P = s[15];
    if (
      (r[0].setComponents(c - a, m - u, h - g, P - T).normalize(),
      r[1].setComponents(c + a, m + u, h + g, P + T).normalize(),
      r[2].setComponents(c + o, m + d, h + M, P + y).normalize(),
      r[3].setComponents(c - o, m - d, h - M, P - y).normalize(),
      n)
    )
      (r[4].setComponents(l, f, p, A).normalize(),
        r[5].setComponents(c - l, m - f, h - p, P - A).normalize());
    else if (
      (r[4].setComponents(c - l, m - f, h - p, P - A).normalize(), t === Kt)
    )
      r[5].setComponents(c + l, m + f, h + p, P + A).normalize();
    else if (t === lr) r[5].setComponents(l, f, p, A).normalize();
    else
      throw new Error(
...
class Ao extends St {
  constructor(e, t, n = Bn, r, s, a, o = Dt, l = Dt, c, u = Ai, d = 1) {
    if (u !== Ai && u !== Ri)
      throw new Error(
...
class fr extends Tn {
  constructor(e = 1, t = 1, n = 1, r = 1) {
    ...
    for (let h = 0; h < u; h++) {
      ...
      for (let y = 0; y < c; y++) {
        const A = y * d - s;
        (g.push(A, -T, 0), M.push(0, 0, 1), p.push(y / o), p.push(1 - h / l));
      }
    }
    for (let h = 0; h < l; h++)
      for (let T = 0; T < o; T++) {
...
#endif`,
  Cl = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
...
#endif`,
  Dl = `float G_BlinnPhong_Implicit( ) {
	return 0.25;
}
...
#endif`,
  Hl = `#define PI 3.141592653589793
...
#endif`,
  Wl = `vec3 transformedNormal = objectNormal;
#ifdef USE_TANGENT
...
#endif`,
  Zl = "gl_FragColor = linearToOutputTexel( gl_FragColor );",
  jl = `vec4 LinearTransferOETF( in vec4 value ) {
	return value;
}
...
IncidentLight directLight;
  ...
  vh = `#if defined( RE_IndirectDiffuse )
	...
	#endif
#endif`,
  Mh = `#if defined( RE_IndirectDiffuse )
	RE_IndirectDiffuse( irradiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif
#if defined( RE_IndirectSpecular )
	RE_IndirectSpecular( radiance, iblIrradiance, clearcoatRadiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif`,
  Sh = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
	gl_FragDepth = vIsPerspective == 0.0 ? gl_FragCoord.z : log2( vFragDepth ) * logDepthBufFC * 0.5;
#endif`,
  bh = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
  ...
  wh = `#if defined( USE_POINTS_UV )
	...
	uniform sampler2D alphaMap;
#endif`,
  Ch = `float metalnessFactor = metalness;
...
#endif`,
  Fh = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
vec3 nonPerturbedNormal = normal;`,
  Oh = `#ifdef USE_NORMALMAP_OBJECTSPACE
...
#endif`,
  kh = `#ifdef USE_CLEARCOAT_NORMALMAP
...
#endif`,
  Jh = `float roughnessFactor = roughness;
...
#endif`,
  pu = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	varying vec2 vUv;
#endif
#ifdef USE_MAP
	varying vec2 vMapUv;
...
#endif`,
  mu = `#if defined( USE_UV ) || defined( USE_ANISOTROPY )
	varying vec2 vUv;
#endif
#ifdef USE_MAP
...
#endif`,
  _u = `#if defined( USE_ENVMAP ) || defined( DISTANCE ) || defined ( USE_SHADOWMAP ) || defined ( USE_TRANSMISSION ) || NUM_SPOT_LIGHT_COORDS > 0
...
void main() {
  ...
  Ie = {
    ...
    aomap_fragment: Tl,
    aomap_pars_fragment: Al,
    batching_pars_vertex: Rl,
    batching_vertex: wl,
    begin_vertex: Cl,
    ...
    clipping_planes_pars_vertex: Fl,
    ...
    defaultnormal_vertex: Wl,
    displacementmap_pars_vertex: Xl,
    displacementmap_vertex: ql,
    ...
    fog_pars_vertex: ih,
    fog_fragment: rh,
    fog_pars_fragment: sh,
    gradientmap_pars_fragment: ah,
    lightmap_pars_fragment: oh,
    lights_lambert_fragment: ch,
    ...
    lights_phong_pars_fragment: mh,
    lights_physical_fragment: xh,
    lights_physical_pars_fragment: _h,
    lights_fragment_begin: gh,
    lights_fragment_maps: vh,
    lights_fragment_end: Mh,
    logdepthbuf_fragment: Sh,
    logdepthbuf_pars_fragment: bh,
    logdepthbuf_pars_vertex: Eh,
    logdepthbuf_vertex: yh,
    map_fragment: Th,
    map_pars_fragment: Ah,
    map_particle_fragment: Rh,
    map_particle_pars_fragment: wh,
    metalnessmap_fragment: Ch,
    metalnessmap_pars_fragment: Ph,
    morphinstance_vertex: Dh,
    ...
    backgroundCube_frag: Su,
    cube_vert: bu,
    cube_frag: Eu,
    depth_vert: yu,
    depth_frag: Tu,
    distanceRGBA_vert: Au,
...
function Qu(i, e, t, n, r, s, a) {
  ...
  function g(y) {
    ...
    return (
      A && A.isTexture && (A = (y.backgroundBlurriness > 0 ? t : e).get(A)),
      A
    );
  }
  function M(y) {
    let A = !1;
    const P = g(y);
    P === null ? h(o, l) : P && P.isColor && (h(P, 1), (A = !0));
  ...
  function p(y, A) {
    ...
    P && (P.isCubeTexture || P.mapping === ur)
      ? (u === void 0 &&
          ((u = new Bt(
            ...
            new fn({
              ...
              uniforms: di(Yt.backgroundCube.uniforms),
          ...
          (u.onBeforeRender = function (E, C, O) {
        ...
        P.isCubeTexture &&
          ...
          ((Ln.y *= -1), (Ln.z *= -1)),
        (u.material.uniforms.envMap.value = P),
        ...
        u.material.uniforms.backgroundRotation.value.setFromMatrix4(
          Ju.makeRotationFromEuler(Ln),
        ),
        (u.material.toneMapped = We.getTransfer(P.colorSpace) !== Ke),
        (d !== P || f !== P.version || m !== i.toneMapping) &&
      ...
      : P &&
        ...
        (c === void 0 &&
          ((c = new Bt(
            ...
            new fn({
              ...
              uniforms: di(Yt.background.uniforms),
        ...
        (c.material.toneMapped = We.getTransfer(P.colorSpace) !== Ke),
  ...
  function h(y, A) {
    (y.getRGB(Ji, bo(i)), n.buffers.color.setClear(Ji.r, Ji.g, Ji.b, A, a));
  }
  function T() {
...
function ed(i, e) {
  ...
  function d(v, D, B) {
    ...
    K === void 0 && ((K = {}), (k[D.id] = K));
    let q = K[V];
    return (q === void 0 && ((q = f(l())), (K[V] = q)), q);
  }
  function f(v) {
    const D = [],
      B = [],
      V = [];
    for (let k = 0; k < t; k++) ((D[k] = 0), (B[k] = 0), (V[k] = 0));
    return {
      geometry: null,
      program: null,
      wireframe: !1,
  ...
  function g(v, D, B, V) {
    ...
    ((s.attributes = k), (s.attributesNum = q), (s.index = V));
  }
  function M() {
    const v = s.newAttributes;
    for (let D = 0, B = v.length; D < B; D++) v[D] = 0;
  }
  function p(v) {
    h(v, 0);
  }
  ...
  function T() {
    ...
    for (let B = 0, V = D.length; B < V; B++)
      D[B] !== v[B] && (i.disableVertexAttribArray(B), (D[B] = 0));
  }
  function y(v, D, B, V, k, K, q) {
    q === !0
      ? i.vertexAttribIPointer(v, D, B, k, K)
      : i.vertexAttribPointer(v, D, B, V, k, K);
  }
  function A(v, D, B, V) {
    M();
          ...
          if (te.isInterleavedBufferAttribute) {
            ...
            if (j.isInstancedInterleavedBuffer) {
              for (let ge = 0; ge < H.locationSize; ge++)
                h(H.location + ge, j.meshPerAttribute);
              v.isInstancedMesh !== !0 &&
            ...
            for (let ge = 0; ge < H.locationSize; ge++)
              y(
                ...
                se,
                de * Qe,
                (Le + (Se / H.locationSize) * ge) * Qe,
                X,
              );
          } else {
            if (te.isInstancedBufferAttribute) {
              for (let j = 0; j < H.locationSize; j++)
                h(H.location + j, te.meshPerAttribute);
              v.isInstancedMesh !== !0 &&
                V._maxInstanceCount === void 0 &&
                (V._maxInstanceCount = te.meshPerAttribute * te.count);
            } else for (let j = 0; j < H.locationSize; j++) p(H.location + j);
            i.bindBuffer(i.ARRAY_BUFFER, Xe);
            for (let j = 0; j < H.locationSize; j++)
              y(
                H.location + j,
  ...
  function P() {
    ...
    for (const v in n) {
      ...
      for (const B in D) {
        const V = D[B];
        for (const k in V) (u(V[k].object), delete V[k]);
        delete D[B];
      }
      delete n[v];
    }
  ...
  ((this.uniform = l),
    ...
    (this.setState = function (d, f, m) {
      ...
      if (!r || g === null || g.length === 0 || (s && !p)) s ? u(null) : c();
        ...
        ((l.value = A), (A = u(g, f, y, m)));
        for (let P = 0; P !== y; ++P) A[P] = t[P];
        ((h.clippingState = A),
  ...
  function u(d, f, m, g) {
    ...
    if (M !== 0) {
      if (((p = l.value), g !== !0 || p === null)) {
        ...
        for (let y = 0, A = m; y !== M; ++y, A += 4)
          (a.copy(d[y]).applyMatrix4(T, o),
            a.normal.toArray(p, A),
            (p[A + 3] = a.constant));
      }
...
function rd(i) {
  let e = new WeakMap();
  function t(a, o) {
    return (o === rs ? (a.mapping = li) : o === ss && (a.mapping = hi), a);
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
class La {
  ...
  fromScene(e, t = 0, n = 0.1, r = 100, s = {}) {
    const { size: a = 256, position: o = ad } = s;
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = Ua(e, t, n)));
  ...
  _textureToCubeUV(e, t) {
    ...
    (ni(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(a, Si));
  }
  _applyPMREM(e) {
  ...
  _applyGGXFilter(e, t, n) {
    ...
    if (this._ggxMaterial === null) {
      const T = 3 * Math.max(this._cubeSize, 16),
        y = 4 * this._cubeSize;
      this._ggxMaterial = cd(this._lodMax, T, y);
    }
  ...
  _halfBlur(e, t, n, r, s, a, o) {
    ...
    const f = c.uniforms,
      ...
      g = isFinite(s) ? Math.PI / (2 * m) : (2 * Math.PI) / (2 * Nn - 1),
      M = s / g,
      p = isFinite(s) ? 1 + Math.floor(u * M) : Nn;
    p > Nn &&
      De(
    ...
    const A = this._sizeLods[r],
      P = 3 * A * (r > y - bn ? r - y + bn : 0),
      E = 4 * (this._cubeSize - A);
    (ni(t, P, E, 3 * A, 2 * A), l.setRenderTarget(t), l.render(d, Si));
  }
}
function od(i) {
  const e = [],
    ...
    n = [];
  let r = i;
  const s = i - bn + 1 + Pa.length;
  for (let a = 0; a < s; a++) {
    const o = Math.pow(2, r);
    e.push(o);
    let l = 1 / o;
    (a > i - bn ? (l = Pa[a - i + bn - 1]) : a === 0 && (l = 0), t.push(l));
    const c = 1 / (o - 2),
      u = -c,
      d = 1 + c,
    ...
    const P = new Tn();
    (P.setAttribute("position", new Zt(T, M)),
      P.setAttribute("uv", new Zt(y, p)),
      P.setAttribute("faceIndex", new Zt(A, h)),
      n.push(new Bt(P, null)),
      r > bn && r--);
  }
  ...
  function s(a, o, l) {
    ...
    if (f === void 0 || f.count !== d) {
      ...
      let A = o.attributes.position.count * y,
        P = 1;
      A > e.maxTextureSize &&
        ((P = Math.ceil(A / e.maxTextureSize)), (A = e.maxTextureSize));
      const E = new Float32Array(A * P * 4 * d),
        C = new xo(E, A, P, d);
        ...
        for (let K = 0; K < D.count; K++) {
          ...
          (m === !0 &&
            ...
            g === !0 &&
              ...
              (E[k + q + 7] = 0)),
            M === !0 &&
              (r.fromBufferAttribute(V, K),
              (E[k + q + 8] = r.x),
              (E[k + q + 9] = r.y),
              (E[k + q + 10] = r.z),
              (E[k + q + 11] = V.itemSize === 4 ? r.w : 1)));
        }
      }
      ((f = { count: d, texture: C, size: new Ne(A, P) }),
        n.set(o, f),
        o.addEventListener("dispose", S));
    }
...
function Sd(i, e) {
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (Ga.set(n), i.uniformMatrix2fv(this.addr, !1, Ga), pt(t, n));
  }
}
function bd(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (Va.set(n), i.uniformMatrix3fv(this.addr, !1, Va), pt(t, n));
  }
}
function Ed(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (za.set(n), i.uniformMatrix4fv(this.addr, !1, za), pt(t, n));
  }
}
function yd(i, e) {
  const t = this.cache;
...
function Ud(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  (n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTexture3D(e || Do, r));
}
function Id(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
  (n[0] !== r && (i.uniform1i(this.addr, r), (n[0] = r)),
    t.setTextureCube(e || Lo, r));
}
function Nd(i, e, t) {
  const n = this.cache,
    r = t.allocateTextureUnit();
...
function Qd(i, e, t) {
  const n = this.cache,
    ...
    s = mr(t, r);
  ft(n, s) || (i.uniform1iv(this.addr, s), pt(n, s));
  for (let a = 0; a !== r; ++a) t.setTexture3D(e[a] || Do, s[a]);
}
function ef(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = mr(t, r);
  ft(n, s) || (i.uniform1iv(this.addr, s), pt(n, s));
  for (let a = 0; a !== r; ++a) t.setTextureCube(e[a] || Lo, s[a]);
}
function tf(i, e, t) {
  const n = this.cache,
    r = e.length,
...
function of(i, e, t) {
  ...
  for (Yr.lastIndex = 0; ; ) {
    ...
    if ((l && (o = o | 0), c === void 0 || (c === "[" && a + 2 === r))) {
      Ha(t, c === void 0 ? new rf(o, i, e) : new sf(o, i, e));
      break;
    } else {
      let d = t.map[o];
      (d === void 0 && ((d = new af(o)), Ha(t, d)), (t = d));
    }
  }
}
class or {
...
const Wa = new Ue();
function uf(i) {
  We._getMatrix(Wa, We.workingColorSpace, i);
  const e = `mat3( ${Wa.elements.map((t) => t.toFixed(4))} )`;
...
const Qi = new F();
function pf() {
  We.getLuminanceCoefficients(Qi);
...
`)),
      (h = [
        ...
        t.toneMapping !== En ? ff("toneMapping", t.toneMapping) : "",
...
` +
  ...
  const y = T + p + a,
    A = T + h + o,
    P = ka(r, r.VERTEX_SHADER, y),
    E = ka(r, r.FRAGMENT_SHADER, A);
  (r.attachShader(M, P),
    r.attachShader(M, E),
  ...
  function C(D) {
    if (i.debug.checkShaderErrors) {
      const B = r.getProgramInfoLog(M) || "",
        V = r.getShaderInfoLog(P) || "",
        k = r.getShaderInfoLog(E) || "",
        K = B.trim(),
        q = V.trim(),
        ne = k.trim();
      let H = !0,
      ...
      if (r.getProgramParameter(M, r.LINK_STATUS) === !1)
        if (((H = !1), typeof i.debug.onShaderError == "function"))
          i.debug.onShaderError(r, M, P, E);
        else {
          const se = Xa(r, P, "vertex"),
            Se = Xa(r, E, "fragment");
          ct(
...
` +
    ...
    (r.deleteShader(P), r.deleteShader(E), (O = new or(r, M)), (S = _f(r, M)));
  }
  let O;
  ...
  return (
    (this.isReady = function () {
      return (v === !1 && (v = r.getProgramParameter(M, cf)), v);
    }),
...
function Lf(i, e, t, n, r, s, a) {
  ...
  function p(S, v, D, B, V) {
    ...
    const tt = {
      ...
      normalMapTangentSpace: Ve && S.normalMapType === Ec,
      metalnessMap: it,
      roughnessMap: Me,
      anisotropy: Pe,
      anisotropyMap: G,
      ...
      gradientMap: ie,
      opaque:
        S.transparent === !1 && S.blending === ai && S.alphaToCoverage === !1,
      alphaMap: re,
      alphaTest: J,
      alphaHash: Y,
      combine: S.combine,
      ...
      lightMapUv: R && M(S.lightMap.channel),
      ...
      specularIntensityMapUv: we && M(S.specularIntensityMap.channel),
      ...
      pointsUvs: V.isPoints === !0 && !!K.attributes.uv && (Be || re),
      fog: !!k,
      useFog: S.fog === !0,
  ...
  function P(S, v) {
    ...
    return (D === void 0 && ((D = new wf(i, v, S, s)), u.push(D)), D);
  }
  function E(S) {
    if (--S.usedTimes === 0) {
      const v = u.indexOf(S);
...
function Vf(i) {
  ...
  function o(c) {
    ...
    for (let S = 0, v = c.length; S < v; S++) {
      ...
      if (D.isAmbientLight) ((u += B.r * V), (d += B.g * V), (f += B.b * V));
        ...
        if ((q.color.copy(D.color).multiplyScalar(D.intensity), D.castShadow)) {
          ...
          ((H.shadowIntensity = ne.intensity),
            ...
            (n.directionalShadowMatrix[m] = D.shadow.matrix),
            T++);
        }
        ((n.directional[m] = q), m++);
        ...
        (q.position.setFromMatrixPosition(D.matrixWorld),
          q.color.copy(B).multiplyScalar(V),
          (q.distance = k),
        ...
        const q = e.get(D);
        (q.skyColor.copy(D.color).multiplyScalar(V),
          q.groundColor.copy(D.groundColor).multiplyScalar(V),
          (n.hemi[h] = q),
          h++);
      }
    }
    ...
    (O.directionalLength !== m ||
      ...
      (n.spotLightMatrix.length = A + P - E),
...
function Wf(i, e, t) {
  ...
  this.render = function (E, C, O) {
    ...
    for (let K = 0, q = E.length; K < q; K++) {
      ...
      if (
        ...
        const Se = this.type !== rn ? { minFilter: Dt, magFilter: Dt } : {};
      ...
      for (let Se = 0; Se < se; Se++) {
        const He = H.getViewport(Se);
        (a.set(s.x * He.x, s.y * He.y, s.x * He.z, s.y * He.w),
          B.viewport(a),
          H.updateMatrices(ne, Se),
          (n = H.getFrustum()),
          A(C, O, H.camera, ne, this.type));
      }
      (H.isPointLightShadow !== !0 && this.type === rn && T(H, O),
        (H.needsUpdate = !1));
    }
    ((h = this.type), (p.needsUpdate = !1), i.setRenderTarget(S, v, D));
  };
  function T(E, C) {
    const O = e.update(M);
    (f.defines.VSM_SAMPLES !== E.blurSamples &&
      ...
      (f.needsUpdate = !0),
      (m.needsUpdate = !0)),
      E.mapPass === null && (E.mapPass = new Vn(r.x, r.y)),
      ...
      i.clear(),
      i.renderBufferDirect(C, null, O, f, M, null),
      ...
      i.clear(),
      i.renderBufferDirect(C, null, O, m, M, null));
  }
  function y(E, C, O, S) {
    let v = null;
    const D =
      O.isPointLight === !0 ? E.customDistanceMaterial : E.customDepthMaterial;
    if (D !== void 0) v = D;
    else if (
      ((v = O.isPointLight === !0 ? l : o),
      ...
      let K = k[V];
      (K === void 0 &&
        ((K = v.clone()), (k[V] = K), C.addEventListener("dispose", P)),
        (v = K));
    }
    if (
      ((v.visible = C.visible),
      (v.wireframe = C.wireframe),
      S === rn
        ? (v.side = C.shadowSide !== null ? C.shadowSide : C.side)
        : (v.side = C.shadowSide !== null ? C.shadowSide : d[C.side]),
      (v.alphaMap = C.alphaMap),
      (v.alphaTest = C.alphaToCoverage === !0 ? 0.5 : C.alphaTest),
      (v.map = C.map),
      (v.clipShadows = C.clipShadows),
      (v.clippingPlanes = C.clippingPlanes),
      (v.clipIntersection = C.clipIntersection),
      (v.displacementMap = C.displacementMap),
      (v.displacementScale = C.displacementScale),
      (v.displacementBias = C.displacementBias),
      (v.wireframeLinewidth = C.wireframeLinewidth),
      (v.linewidth = C.linewidth),
      O.isPointLight === !0 && v.isMeshDistanceMaterial === !0)
    ) {
  ...
  function A(E, C, O, S, v) {
    if (E.visible === !1) return;
    if (
      E.layers.test(C.layers) &&
      (E.isMesh || E.isLine || E.isPoints) &&
      (E.castShadow || (E.receiveShadow && v === rn)) &&
      ...
      if (Array.isArray(k)) {
        ...
        for (let q = 0, ne = K.length; q < ne; q++) {
          ...
          if (te && te.visible) {
            const se = y(E, te, S, v);
            (E.onBeforeShadow(i, E, C, O, V, se, H),
              i.renderBufferDirect(O, null, V, se, E, H),
              E.onAfterShadow(i, E, C, O, V, se, H));
          }
        }
      } else if (k.visible) {
        const K = y(E, k, S, v);
        (E.onBeforeShadow(i, E, C, O, V, K, null),
          i.renderBufferDirect(O, null, V, K, E, null),
          E.onAfterShadow(i, E, C, O, V, K, null));
      }
    }
    const B = E.children;
    for (let V = 0, k = B.length; V < k; V++) A(B[V], C, O, S, v);
  }
  function P(E) {
    E.target.removeEventListener("dispose", P);
    for (const O in c) {
      const S = c[O],
        v = E.target.uuid;
...
function qf(i, e) {
  ...
  function n() {
    ...
    return {
      ...
      setTest: function (Y) {
        Y ? j(i.DEPTH_TEST) : de(i.DEPTH_TEST);
      },
      setMask: function (Y) {
  ...
  function r() {
    ...
    return {
      setTest: function (qe) {
        w || (qe ? j(i.STENCIL_TEST) : de(i.STENCIL_TEST));
      },
      setMask: function (qe) {
        ce !== qe && !w && (i.stencilMask(qe), (ce = qe));
      },
      setFunc: function (qe, qt, Vt) {
        (ie !== qe || re !== qt || J !== Vt) &&
          (i.stencilFunc(qe, qt, Vt), (ie = qe), (re = qt), (J = Vt));
      },
      setOp: function (qe, qt, Vt) {
        (Y !== qe || fe !== qt || Ce !== Vt) &&
          (i.stencilOp(qe, qt, Vt), (Y = qe), (fe = qt), (Ce = Vt));
      },
  ...
  const xt = {
    [In]: i.FUNC_ADD,
    [Ko]: i.FUNC_SUBTRACT,
    [Zo]: i.FUNC_REVERSE_SUBTRACT,
  };
  ((xt[jo] = i.MIN), (xt[$o] = i.MAX));
  const Fe = {
    [Jo]: i.ZERO,
    [Qo]: i.ONE,
    [ec]: i.SRC_COLOR,
  ...
  function nt(w, ce, ie, re, J, Y, fe, Ce, tt, qe) {
    ...
    if ((M === !1 && (j(i.BLEND), (M = !0)), w !== Yo)) {
      if (w !== p || qe !== S) {
        if (
          ((h !== In || A !== In) &&
            (i.blendEquation(i.FUNC_ADD), (h = In), (A = In)),
          qe)
        )
          switch (w) {
            case ai:
    ...
    ((J = J || ce),
      ...
      (fe = fe || re),
      (ce !== h || J !== A) &&
        (i.blendEquationSeparate(xt[ce], xt[J]), (h = ce), (A = J)),
      (ie !== T || re !== y || Y !== P || fe !== E) &&
        ...
        (E = fe)),
      (Ce.equals(C) === !1 || tt !== O) &&
        (i.blendColor(Ce.r, Ce.g, Ce.b, tt), C.copy(Ce), (O = tt)),
      (p = w),
      (S = !1));
  }
  function R(w, ce) {
    w.side === sn ? de(i.CULL_FACE) : j(i.CULL_FACE);
    let ie = w.side === At;
    (ce && (ie = !ie),
      ze(ie),
      w.blending === ai && w.transparent === !1
        ? nt(ln)
        : nt(
            w.blending,
            w.blendEquation,
  ...
  function me(w, ce, ie) {
    w
      ? (j(i.POLYGON_OFFSET_FILL),
        (V !== ce || k !== ie) && (i.polygonOffset(ce, ie), (V = ce), (k = ie)))
...
function Yf(i, e, t, n, r, s, a) {
  ...
  function g(b, x) {
    return m ? new OffscreenCanvas(b, x) : hr("canvas");
  }
  function M(b, x, I) {
    let W = 1;
    const Z = Pe(b);
    if (
      ...
      if (
        ...
        return (
          (oe.width = G),
          (oe.height = _e),
          oe.getContext("2d").drawImage(b, 0, 0, G, _e),
          De(
  ...
  function y(b, x, I, W, Z = !1) {
    ...
    if (
      ...
      const _e = Z ? cr : We.getTransfer(W);
      ...
      b
        ...
        : x === null || x === Bn || x === Ti
          ...
          : x === on
            ...
            : x === yi && (I = i.DEPTH_COMPONENT16),
      I
    );
  }
  function P(b, x) {
    return p(b) === !0 ||
      (b.isFramebufferTexture && b.minFilter !== Dt && b.minFilter !== Ot)
  ...
  function C(b) {
    const x = b.target;
    (x.removeEventListener("dispose", C), v(x));
  }
  function O(b) {
    const x = n.get(b);
  ...
  const te = { [as]: i.REPEAT, [an]: i.CLAMP_TO_EDGE, [os]: i.MIRRORED_REPEAT },
    se = {
      [Dt]: i.NEAREST,
  ...
  function He(b, x) {
    if (
      ...
      if (
        x.magFilter === Dt ||
        (x.minFilter !== Ui && x.minFilter !== Fn) ||
        (x.type === on && e.has("OES_texture_float_linear") === !1)
      )
        return;
  ...
  function Xe(b, x) {
    ...
    if (G !== b.__cacheKey) {
      (Z[G] === void 0 &&
        ((Z[G] = { texture: i.createTexture(), usedTimes: 0 }),
        a.memory.textures++,
        (I = !0)),
        Z[G].usedTimes++);
    ...
    if (G.length === 0)
      ...
      for (let $ = 0, ee = G.length; $ < ee; $++) {
        ...
        (i.pixelStorei(i.UNPACK_SKIP_PIXELS, we),
          ...
          t.texSubImage2D(i.TEXTURE_2D, 0, we, w, ce, ie, I, W, x.data));
      }
      (b.clearUpdateRanges(),
  ...
  function X(b, x, I) {
    ...
    if (G.version !== _e.__version || Z === !0) {
      ...
      const oe = We.getPrimaries(We.workingColorSpace),
        be = x.colorSpace === Sn ? null : We.getPrimaries(x.colorSpace),
        xe =
      ...
      if (x.isDepthTexture)
        ...
        if (we.length > 0) {
          w &&
            ce &&
            t.texStorage2D(i.TEXTURE_2D, re, ye, we[0].width, we[0].height);
          for (let J = 0, Y = we.length; J < Y; J++)
            ((he = we[J]),
              w
                ? ie &&
                  t.texSubImage2D(
        ...
        if (x.isCompressedArrayTexture) {
          ...
          for (let J = 0, Y = we.length; J < Y; J++)
            if (((he = we[J]), x.format !== Xt))
              if (ee !== null)
                if (w) {
                  if (ie)
                    if (x.layerUpdates.size > 0) {
                      const fe = Ca(he.width, he.height, x.format, x.type);
        ...
        if (w) {
          if (
            ...
            if (x.layerUpdates.size > 0) {
              const J = Ca($.width, $.height, x.format, x.type);
      ...
      (p(x) && h(W), (_e.__version = G.version), x.onUpdate && x.onUpdate(x));
    }
  ...
  function j(b, x, I) {
    ...
    const G = n.get(Z);
    if (Z.version !== G.__version || W === !0) {
      t.activeTexture(i.TEXTURE0 + I);
      const _e = We.getPrimaries(We.workingColorSpace),
        oe = x.colorSpace === Sn ? null : We.getPrimaries(x.colorSpace),
        be =
      ...
      const Ae = ee[0],
        ...
        he = s.convert(x.type),
        we = y(x.internalFormat, ye, he, x.colorSpace),
        w = x.isVideoTexture !== !0,
      ...
      if (xe) {
        w &&
          ce &&
          t.texStorage2D(i.TEXTURE_CUBE_MAP, re, we, Ae.width, Ae.height);
        for (let Y = 0; Y < 6; Y++) {
          J = ee[Y].mipmaps;
        ...
        if (((J = x.mipmaps), w && ce)) {
          J.length > 0 && re++;
          const Y = Pe(ee[0]);
          t.texStorage2D(i.TEXTURE_CUBE_MAP, re, we, Y.width, Y.height);
        }
        for (let Y = 0; Y < 6; Y++)
          if ($) {
            w
  ...
  function de(b, x, I, W, Z, G) {
    ...
    if ((($.__renderTarget = x), !xe.__hasExternalTextures)) {
      ...
      Z === i.TEXTURE_3D || Z === i.TEXTURE_2D_ARRAY
        ? t.texImage3D(Z, G, be, ee, Ae, x.depth, 0, _e, oe, null)
        : t.texImage2D(Z, G, be, ee, Ae, 0, _e, oe, null);
    }
    (t.bindFramebuffer(i.FRAMEBUFFER, b),
      me(x)
        ...
        : (Z === i.TEXTURE_2D ||
          ...
          i.framebufferTexture2D(i.FRAMEBUFFER, W, Z, $.__webglTexture, G),
  ...
  function ge(b, x) {
    ...
    else if (x.depthTexture.format === Ri)
      me(x)
        ? o.framebufferTexture2DMultisampleEXT(
            i.FRAMEBUFFER,
      ...
      for (let W = 0; W < 6; W++)
        if (
          ...
          (i.bindRenderbuffer(i.RENDERBUFFER, G),
            i.framebufferRenderbuffer(i.FRAMEBUFFER, Z, i.RENDERBUFFER, G));
        }
    } else {
      const W = b.texture.mipmaps;
      if (
  ...
  function nt(b) {
    ...
    for (let I = 0, W = x.length; I < W; I++) {
      ...
      if (p(Z)) {
        ...
        (t.bindTexture(G, _e), h(G), t.unbindTexture());
      }
    }
  }
  const R = [],
        ...
        for (let xe = 0; xe < x.length; xe++) {
          ...
          (i.blitFramebuffer(0, 0, I, W, 0, 0, I, W, Z, i.NEAREST),
            l === !0 &&
              ((R.length = 0),
              (ze.length = 0),
              R.push(i.COLOR_ATTACHMENT0 + xe),
              b.depthBuffer &&
                b.resolveDepthBuffer === !1 &&
                (R.push(G),
                ze.push(G),
                i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER, ze)),
              i.invalidateFramebuffer(i.READ_FRAMEBUFFER, R)));
        }
        if (
...
function Kf(i, e) {
  function t(n, r = Sn) {
    ...
    if (n === lo) return i.UNSIGNED_INT_10F_11F_11F_REV;
    ...
    if (n === Cs || n === Ps || n === Ds)
      if (((s = e.get("EXT_texture_compression_bptc")), s !== null)) {
        ...
        if (n === Ps) return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;
        if (n === Ds) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (n === Ls || n === Us || n === Is || n === Ns)
      if (((s = e.get("EXT_texture_compression_rgtc")), s !== null)) {
        if (n === Ls) return s.COMPRESSED_RED_RGTC1_EXT;
        if (n === Us) return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;
        if (n === Is) return s.COMPRESSED_RED_GREEN_RGTC2_EXT;
        if (n === Ns) return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT;
      } else return null;
...
class $f {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new Bt(new fr(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(e, t) {
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (X) {
        let j = P[X];
        return (
          j === void 0 && ((j = new Gr()), (P[X] = j)),
          j.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (X) {
        let j = P[X];
        return (j === void 0 && ((j = new Gr()), (P[X] = j)), j.getGripSpace());
      }),
      (this.getHand = function (X) {
        let j = P[X];
        return (j === void 0 && ((j = new Gr()), (P[X] = j)), j.getHandSpace());
      }));
    function K(X) {
    ...
    function q() {
      ...
      for (let X = 0; X < P.length; X++) {
        const j = E[X];
        j !== null && ((E[X] = null), P[X].disconnect(j));
      }
        ...
        if (((r = X), r !== null)) {
          if (
            ...
            ((d = this.getBinding()),
              ...
              (A = new Vn(f.textureWidth, f.textureHeight, {
                format: Xt,
                type: un,
                depthTexture: new Ao(
                  f.textureWidth,
            ...
            ((m = new XRWebGLLayer(r, t, de)),
              ...
              (A = new Vn(m.framebufferWidth, m.framebufferHeight, {
                format: Xt,
                type: un,
                colorSpace: e.outputColorSpace,
                stencilBuffer: T.stencil,
    ...
    function ne(X) {
      for (let j = 0; j < X.removed.length; j++) {
        const de = X.removed[j],
          Le = E.indexOf(de);
        Le >= 0 && ((E[Le] = null), P[Le].disconnect(de));
      }
    ...
    function He(X, j, de) {
      (de === null
        ...
        X.isPerspectiveCamera &&
          ((X.fov = Fs * 2 * Math.atan(1 / X.projectionMatrix.elements[5])),
          (X.zoom = 1)));
    }
      ...
      if (((u = j.getViewerPose(c || a)), (g = j), u !== null)) {
        ...
        for (let Fe = 0; Fe < de.length; Fe++) {
          ...
          (ze === void 0 &&
            ...
            ze.viewport.set(R.x, R.y, R.width, R.height),
            Fe === 0 &&
      ...
      : h.isMeshToonMaterial
        ...
        : h.isMeshPhongMaterial
          ...
          : h.isMeshStandardMaterial
            ? (s(p, h), f(p, h), h.isMeshPhysicalMaterial && m(p, h, A))
  ...
  function s(p, h) {
    ...
    (y &&
      ...
      y.isCubeTexture &&
        ...
        ((Un.y *= -1), (Un.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(Qf.makeRotationFromEuler(Un)),
      (p.flipEnvMap.value =
    ...
    ((p.ior.value = h.ior),
      ...
      h.clearcoat > 0 &&
        ...
        h.clearcoatNormalMap &&
          ...
          h.side === At && p.clearcoatNormalScale.value.negate())),
...
function tp(i, e, t, n) {
  ...
  function c(T, y) {
    let A = r[T.id];
    A === void 0 &&
      (g(T), (A = u(T)), (r[T.id] = A), T.addEventListener("dispose", p));
    const P = y.program;
  ...
  function u(T) {
    ...
    return (
      ...
      i.bufferData(i.UNIFORM_BUFFER, P, E),
      i.bindBuffer(i.UNIFORM_BUFFER, null),
      i.bindBufferBase(i.UNIFORM_BUFFER, y, A),
      A
    );
  }
  function d() {
        ...
        if (m(D, E, S, P) === !0) {
          ...
          for (let K = 0; K < V.length; K++) {
            ...
            typeof q == "number" || typeof q == "boolean"
              ? ((D.__data[0] = q),
                i.bufferSubData(i.UNIFORM_BUFFER, B + k, D.__data))
              : q.isMatrix3
  ...
  function m(T, y, A, P) {
      ...
      );
    {
      ...
      if (typeof E == "number" || typeof E == "boolean") {
        if (O !== E) return ((P[C] = E), !0);
      } else if (O.equals(E) === !1) return (O.copy(E), !0);
    }
    return !1;
  }
  function g(T) {
    ...
    const E = A % P;
    return (E > 0 && (A += P - E), (T.__size = A), (T.__cache = {}), this);
  }
  function M(T) {
  ...
  function p(T) {
    ...
    (a.splice(A, 1), i.deleteBuffer(r[y.id]), delete r[y.id], delete s[y.id]);
  }
  function h() {
  ...
  constructor(e = {}) {
    ...
    function ie() {
      ((Ve = new ud(R)),
        ...
        (Ae = new md(R, et, Pe)),
        (xe = new id(Me)),
        (G = new Lf(E, b, x, Ve, et, w, xe)),
        (_e = new ep(E, Me)),
        (oe = new Nf()),
        (be = new Gf(Ve)),
        (ee = new Qu(E, b, x, me, Z, m, l)),
        ($ = new Wf(E, Z, et)),
        (ce = new tp(R, it, et, me)),
        (ye = new td(R, Ve, it)),
        (he = new fd(R, Ve, it)),
        (it.programs = G.programs),
        (E.capabilities = et),
        (E.extensions = Ve),
        (E.properties = Me),
        (E.renderLists = oe),
    ...
    ((this.xr = re),
      ...
      (this.setViewport = function (_, L, N, z) {
        (_.isVector4 ? Xe.set(_.x, _.y, _.z, _.w) : Xe.set(_, L, N, z),
          me.viewport(V.copy(Xe).multiplyScalar(se).round()));
      }),
      (this.getScissor = function (_) {
        return _.copy(Je);
      }),
      (this.setScissor = function (_, L, N, z) {
        (_.isVector4 ? Je.set(_.x, _.y, _.z, _.w) : Je.set(_, L, N, z),
          ...
          if (U) {
            ...
            le
              ...
              : ((h[0] = Te),
                ...
                (h[2] = ve),
                (h[3] = ue),
                R.clearBufferiv(R.COLOR, 0, h));
          } else z |= R.COLOR_BUFFER_BIT;
        }
        (L && (z |= R.DEPTH_BUFFER_BIT),
          N &&
            ((z |= R.STENCIL_BUFFER_BIT),
      ...
      (this.dispose = function () {
        (t.removeEventListener("webglcontextlost", J, !1),
          ...
          re.removeEventListener("sessionend", $s),
          An.stop());
      }));
    function J(_) {
      (_.preventDefault(), ua("WebGLRenderer: Context Lost."), (C = !0));
    }
    function Y() {
      (ua("WebGLRenderer: Context Restored."), (C = !1));
    ...
    this.renderBufferDirect = function (_, L, N, z, U, Q) {
      L === null && (L = xt);
      ...
      const Re = N.drawRange,
        ve = N.attributes.position;
      let Ge = Re.start * Te,
        Ye = (Re.start + Re.count) * Te;
      (Q !== null &&
      ...
      if (
        ...
        z.wireframe === !0
          ? (me.setLineWidth(z.wireframeLinewidth * nt()), $e.setMode(R.LINES))
          : $e.setMode(R.TRIANGLES);
      else if (U.isLine) {
        let Ee = z.linewidth;
        (Ee === void 0 && (Ee = 1),
          ...
          U.isLineSegments
            ? $e.setMode(R.LINES)
            : U.isLineLoop
              ? $e.setMode(R.LINE_LOOP)
              : $e.setMode(R.LINE_STRIP));
      } else
        U.isPoints
          ? $e.setMode(R.POINTS)
          : U.isSprite && $e.setMode(R.TRIANGLES);
      if (U.isBatchedMesh)
        if (U._multiDrawInstances !== null)
          ...
          const Ee = U._multiDrawStarts,
            ...
            Hn = Me.get(z).currentProgram.getUniforms();
          for (let wt = 0; wt < ke; wt++)
            (Hn.setValue(R, "_gl_DrawID", wt), $e.render(Ee[wt] / Rt, rt[wt]));
        }
    ...
    function qt(_, L, N) {
      _.transparent === !0 && _.side === sn && _.forceSinglePass === !1
        ? ((_.side = At),
          (_.needsUpdate = !0),
          Li(_, L, N),
          (_.side = yn),
    ...
    const An = new wo();
    (An.setAnimationLoop(Oo),
      typeof self < "u" && An.setContext(self),
      (this.setAnimationLoop = function (_) {
        ((Vt = _), re.setAnimationLoop(_), _ === null ? An.stop() : An.start());
      }),
      re.addEventListener("sessionstart", js),
      re.addEventListener("sessionend", $s),
      (this.render = function (_, L) {
        ...
        if (
          ...
          X.setFromProjectionMatrix(Le, Kt, L.reversedDepth),
          ...
          Q !== null && _r(Q, L, -1 / 0, E.sortObjects);
        }
        (_r(_, L, 0, E.sortObjects),
          T.finish(),
          E.sortObjects === !0 && T.sort(Se, He),
          (Fe =
            re.enabled === !1 ||
            re.isPresenting === !1 ||
        ...
        if ((y.setupLights(), L.isArrayCamera)) {
          ...
          for (let le = 0, pe = Q.length; le < pe; le++) {
            const ue = Q[le];
            Js(T, _, ue, ue.viewport);
          }
        } else
          (U.length > 0 && Qs(z, U, _, L), Fe && ee.render(_), Js(T, _, L));
        (v !== null &&
          S === 0 &&
          ...
          P.length > 0
            ...
            : (y = null),
          A.pop(),
          A.length > 0 ? (T = A[A.length - 1]) : (T = null));
      }));
    function _r(_, L, N, z) {
      ...
      if (_.layers.test(L.layers)) {
        if (_.isGroup) N = _.renderOrder;
          ...
          if (!_.frustumCulled || X.intersectsSprite(_)) {
            z && Be.setFromMatrixPosition(_.matrixWorld).applyMatrix4(Le);
            const le = Z.update(_),
              pe = _.material;
          ...
          if (
            ...
            const ue = le.groups;
            for (let Te = 0, Re = ue.length; Te < Re; Te++) {
              const ve = ue[Te],
      ...
      const Q = _.children;
      for (let le = 0, pe = Q.length; le < pe; le++) _r(Q[le], L, N, z);
    }
    function Js(_, L, N, z) {
      const { opaque: U, transmissive: Q, transparent: le } = _;
      (y.setupLightsView(N),
        j === !0 && xe.setGlobalState(E.clippingPlanes, N),
        z && me.viewport(V.copy(z)),
        U.length > 0 && Di(U, L, N),
        Q.length > 0 && Di(Q, L, N),
        le.length > 0 && Di(le, L, N),
    ...
    function Qs(_, L, N, z) {
      ...
      y.state.transmissionRenderTarget[z.id] === void 0 &&
        (y.state.transmissionRenderTarget[z.id] = new Vn(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      const Q = y.state.transmissionRenderTarget[z.id],
        le = z.viewport || V;
      Q.setSize(
        le.z * E.transmissionResolutionScale,
      ...
      if (
        ...
        y.setupLightsView(z),
        j === !0 && xe.setGlobalState(E.clippingPlanes, z),
        Di(_, N, z),
        ...
        for (let Ye = 0, at = L.length; Ye < at; Ye++) {
          const ot = L[Ye],
            { object: $e, geometry: Ee, material: rt, group: ke } = ot;
          if (rt.side === sn && $e.layers.test(z.layers)) {
            const Rt = rt.side;
            ((rt.side = At),
              (rt.needsUpdate = !0),
              ea($e, N, z, Ee, rt, ke),
      ...
      (E.setRenderTarget(pe, ue, Te),
        E.setClearColor(q, ne),
        ve !== void 0 && (z.viewport = ve),
        (E.toneMapping = Re));
    }
    function Di(_, L, N) {
      ...
      for (let U = 0, Q = _.length; U < Q; U++) {
        ...
        let Re = le.material;
        (Re.allowOverride === !0 && z !== null && (Re = z),
          pe.layers.test(N.layers) && ea(pe, L, N, ue, Re, Te));
      }
    }
    function ea(_, L, N, z, U, Q) {
      (_.onBeforeRender(E, L, N, z, U, Q),
        _.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse, _.matrixWorld),
        _.normalMatrix.getNormalMatrix(_.modelViewMatrix),
        U.onBeforeRender(E, L, N, z, _, Q),
        U.transparent === !0 && U.side === sn && U.forceSinglePass === !1
          ? ((U.side = At),
            (U.needsUpdate = !0),
            E.renderBufferDirect(N, L, z, U, _, Q),
            (U.side = yn),
            (U.needsUpdate = !0),
            E.renderBufferDirect(N, L, z, U, _, Q),
            (U.side = sn))
          : E.renderBufferDirect(N, L, z, U, _, Q),
        _.onAfterRender(E, L, N, z, U, Q));
    }
    function Li(_, L, N) {
      L.isScene !== !0 && (L = xt);
      const z = Me.get(_),
        ...
        le = U.state.version,
        pe = G.getParameters(_, U.state, Q, L, N),
        ue = G.getProgramCacheKey(pe);
      let Te = z.programs;
      ((z.environment = _.isMeshStandardMaterial ? L.environment : null),
        (z.fog = L.fog),
        (z.envMap = (_.isMeshStandardMaterial ? x : b).get(
          _.envMap || z.environment,
        )),
        (z.envMapRotation =
          z.environment !== null && _.envMap === null
      ...
      let Re = Te.get(ue);
      if (Re !== void 0) {
        if (z.currentProgram === Re && z.lightsStateVersion === le)
          return (na(_, pe), Re);
      } else
        ((pe.uniforms = G.getUniforms(_)),
          _.onBeforeCompile(pe, E),
          (Re = G.acquireProgram(pe, ue)),
          Te.set(ue, Re),
          (z.uniforms = pe.uniforms));
      const ve = z.uniforms;
      return (
    ...
    function ta(_) {
      if (_.uniformsList === null) {
        ...
        _.uniformsList = or.seqWithValue(L.seq, _.uniforms);
      }
    ...
    function Bo(_, L, N, z, U) {
      (L.isScene !== !0 && (L = xt), Pe.resetTextureUnits());
      const Q = L.fog,
        le = z.isMeshStandardMaterial ? L.environment : null,
        pe =
          v === null
            ? E.outputColorSpace
            : v.isXRRenderTarget === !0
              ...
              : ui,
        ue = (z.isMeshStandardMaterial ? x : b).get(z.envMap || le),
        Te =
          z.vertexColors === !0 &&
          !!N.attributes.color &&
          N.attributes.color.itemSize === 4,
        Re = !!N.attributes.tangent && (!!z.normalMap || z.anisotropy > 0),
      ...
      const st = Rt.getUniforms(),
        bt = Ee.uniforms;
      if (
        (me.useProgram(Rt.program) && ((Hn = !0), (wt = !0), (mi = !0)),
        z.id !== D && ((D = z.id), (wt = !0)),
        Hn || B !== _)
      ) {
        (me.buffers.depth.getReversed() &&
          ...
          st.setValue(R, "projectionMatrix", _.projectionMatrix),
          st.setValue(R, "viewMatrix", _.matrixWorldInverse));
        const Et = st.map.cameraPosition;
        (Et !== void 0 &&
          Et.setValue(R, ge.setFromMatrixPosition(_.matrixWorld)),
          ...
          (z.isMeshPhongMaterial ||
            ...
            z.isShaderMaterial) &&
            st.setValue(R, "isOrthographic", _.isOrthographicCamera === !0),
          B !== _ && ((B = _), (wt = !0), (mi = !0)));
      }
      if (U.isSkinnedMesh) {
        (st.setOptional(R, U, "bindMatrix"),
          st.setOptional(R, U, "bindMatrixInverse"));
        const vt = U.skeleton;
        vt &&
          (vt.boneTexture === null && vt.computeBoneTexture(),
          st.setValue(R, "boneTexture", vt.boneTexture, Pe));
      }
      U.isBatchedMesh &&
        (st.setOptional(R, U, "batchingTexture"),
        st.setValue(R, "batchingTexture", U._matricesTexture, Pe),
        st.setOptional(R, U, "batchingIdTexture"),
        st.setValue(R, "batchingIdTexture", U._indirectTexture, Pe),
        st.setOptional(R, U, "batchingColorTexture"),
        U._colorsTexture !== null &&
          st.setValue(R, "batchingColorTexture", U._colorsTexture, Pe));
      ...
      if (
        ...
        (wt || Ee.receiveShadow !== U.receiveShadow) &&
          ...
          st.setValue(R, "receiveShadow", U.receiveShadow)),
        ...
        bt.dfgLUT !== void 0 && (bt.dfgLUT.value = ip()),
        wt &&
          (st.setValue(R, "toneMappingExposure", E.toneMappingExposure),
          Ee.needsLights && zo(bt, mi),
          Q && z.fog === !0 && _e.refreshFogUniforms(bt, Q),
          ...
          or.upload(R, ta(Ee), bt, Pe)),
        z.isShaderMaterial &&
          z.uniformsNeedUpdate === !0 &&
          (or.upload(R, ta(Ee), bt, Pe), (z.uniformsNeedUpdate = !1)),
        z.isSpriteMaterial && st.setValue(R, "center", U.center),
        st.setValue(R, "modelViewMatrix", U.modelViewMatrix),
        st.setValue(R, "normalMatrix", U.normalMatrix),
        st.setValue(R, "modelMatrix", U.matrixWorld),
        z.isShaderMaterial || z.isRawShaderMaterial)
      ) {
        const vt = z.uniformsGroups;
        for (let Et = 0, gr = vt.length; Et < gr; Et++) {
          const Rn = vt[Et];
          (ce.update(Rn, Rt), ce.bind(Rn, Rt));
        }
      }
      return Rt;
    }
    ...
    ((this.getActiveCubeFace = function () {
      ...
      (this.setRenderTargetTextures = function (_, L, N) {
        const z = Me.get(_);
        ((z.__autoAllocateDepthBuffer = _.resolveDepthBuffer === !1),
          z.__autoAllocateDepthBuffer === !1 && (z.__useRenderToTexture = !1),
          (Me.get(_.texture).__webglTexture = L),
          (Me.get(_.depthTexture).__webglTexture = z.__autoAllocateDepthBuffer
            ? void 0
            : N),
    ...
    ((this.setRenderTarget = function (_, L = 0, N = 0) {
      ...
      if (_) {
        ...
        if (ue.__useDefaultFramebuffer !== void 0)
          (me.bindFramebuffer(R.FRAMEBUFFER, null), (z = !1));
        ...
        (Te.isData3DTexture ||
          ...
          (le = !0);
        const Re = Me.get(_).__webglFramebuffer;
        (_.isWebGLCubeRenderTarget
          ? (Array.isArray(Re[L]) ? (U = Re[L][N]) : (U = Re[L]), (Q = !0))
        ...
        (V.copy(Xe).multiplyScalar(se).floor(),
          k.copy(Je).multiplyScalar(se).floor(),
          (K = Qe));
      if (
        (N !== 0 && (U = Go),
        me.bindFramebuffer(R.FRAMEBUFFER, U) && z && me.drawBuffers(_, U),
        me.viewport(V),
        me.scissor(k),
        me.setScissorTest(K),
        Q)
        ...
        R.framebufferTexture2D(
          R.FRAMEBUFFER,
          R.COLOR_ATTACHMENT0,
          R.TEXTURE_CUBE_MAP_POSITIVE_X + L,
          ue.__webglTexture,
          N,
        );
      } else if (le) {
      ...
      (this.readRenderTargetPixels = function (_, L, N, z, U, Q, le, pe = 0) {
        ...
        if ((_.isWebGLCubeRenderTarget && le !== void 0 && (ue = ue[le]), ue)) {
          me.bindFramebuffer(R.FRAMEBUFFER, ue);
          try {
            const Te = _.textures[pe],
              Re = Te.format,
              ve = Te.type;
            if (!et.textureFormatReadable(Re)) {
              ct(
            ...
            L >= 0 &&
              ...
              N >= 0 &&
              N <= _.height - U &&
              (_.textures.length > 1 && R.readBuffer(R.COLOR_ATTACHMENT0 + pe),
              R.readPixels(L, N, z, U, we.convert(Re), we.convert(ve), Q));
          } finally {
            const Te = v !== null ? Me.get(v).__webglFramebuffer : null;
            me.bindFramebuffer(R.FRAMEBUFFER, Te);
          }
        }
      }),
      (this.readRenderTargetPixelsAsync = async function (
        ...
        let ue = Me.get(_).__webglFramebuffer;
        if ((_.isWebGLCubeRenderTarget && le !== void 0 && (ue = ue[le]), ue))
          if (L >= 0 && L <= _.width - z && N >= 0 && N <= _.height - U) {
            me.bindFramebuffer(R.FRAMEBUFFER, ue);
            const Te = _.textures[pe],
              Re = Te.format,
              ve = Te.type;
            ...
            const Ge = R.createBuffer();
            (R.bindBuffer(R.PIXEL_PACK_BUFFER, Ge),
              R.bufferData(R.PIXEL_PACK_BUFFER, Q.byteLength, R.STREAM_READ),
              _.textures.length > 1 && R.readBuffer(R.COLOR_ATTACHMENT0 + pe),
              R.readPixels(L, N, z, U, we.convert(Re), we.convert(ve), 0));
            const Ye = v !== null ? Me.get(v).__webglFramebuffer : null;
            me.bindFramebuffer(R.FRAMEBUFFER, Ye);
            const at = R.fenceSync(R.SYNC_GPU_COMMANDS_COMPLETE, 0);
            return (
              R.flush(),
              await Uc(R, at, 4),
              R.bindBuffer(R.PIXEL_PACK_BUFFER, Ge),
      ...
      (this.copyFramebufferToTexture = function (_, L = null, N = 0) {
        const z = Math.pow(2, -N),
          U = Math.floor(_.image.width * z),
          Q = Math.floor(_.image.height * z),
          le = L !== null ? L.x : 0,
          pe = L !== null ? L.y : 0;
        (Pe.setTexture2D(_, 0),
          R.copyTexSubImage2D(R.TEXTURE_2D, N, 0, 0, le, pe, U, Q),
          me.unbindTexture());
      }));
    const Ho = R.createFramebuffer(),
      ko = R.createFramebuffer();
    ((this.copyTextureToTexture = function (
      ...
      Q === null &&
        (U !== 0
          ? (wi(
            ...
            (U = 0))
          : (Q = 0));
      let le, pe, ue, Te, Re, ve, Ge, Ye, at;
      ...
      if (N !== null)
        ...
        ((le = Math.floor(ot.width * Ut)),
          (pe = Math.floor(ot.height * Ut)),
          _.isDataArrayTexture
            ? (ue = ot.depth)
            : _.isData3DTexture
              ? (ue = Math.floor(ot.depth * Ut))
              : (ue = 1),
          (Te = 0),
          (Re = 0),
          (ve = 0));
      ...
      z !== null
        ? ((Ge = z.x), (Ye = z.y), (at = z.z))
        : ((Ge = 0), (Ye = 0), (at = 0));
      const $e = we.convert(L.format),
        Ee = we.convert(L.type);
      let rt;
      (L.isData3DTexture
        ? (Pe.setTexture3D(L, 0), (rt = R.TEXTURE_3D))
        : L.isDataArrayTexture || L.isCompressedArrayTexture
          ? (Pe.setTexture2DArray(L, 0), (rt = R.TEXTURE_2D_ARRAY))
          : (Pe.setTexture2D(L, 0), (rt = R.TEXTURE_2D)),
      ...
      const ke = R.getParameter(R.UNPACK_ROW_LENGTH),
        Rt = R.getParameter(R.UNPACK_IMAGE_HEIGHT),
        Hn = R.getParameter(R.UNPACK_SKIP_PIXELS),
        wt = R.getParameter(R.UNPACK_SKIP_ROWS),
        mi = R.getParameter(R.UNPACK_SKIP_IMAGES);
      (R.pixelStorei(R.UNPACK_ROW_LENGTH, ot.width),
        R.pixelStorei(R.UNPACK_IMAGE_HEIGHT, ot.height),
        R.pixelStorei(R.UNPACK_SKIP_PIXELS, Te),
        R.pixelStorei(R.UNPACK_SKIP_ROWS, Re),
      ...
      if (_.isDepthTexture) {
        const Ut = Me.get(_),
          ...
          gr = Me.get(vt.__renderTarget);
        (me.bindFramebuffer(R.READ_FRAMEBUFFER, Et.__webglFramebuffer),
          me.bindFramebuffer(R.DRAW_FRAMEBUFFER, gr.__webglFramebuffer));
        for (let Rn = 0; Rn < ue; Rn++)
          (st &&
            (R.framebufferTextureLayer(
              R.READ_FRAMEBUFFER,
              R.COLOR_ATTACHMENT0,
        ...
        (me.bindFramebuffer(R.READ_FRAMEBUFFER, null),
          me.bindFramebuffer(R.DRAW_FRAMEBUFFER, null));
      } else if (U !== 0 || _.isRenderTargetTexture || Me.has(_)) {
        const Ut = Me.get(_),
          vt = Me.get(L);
        (me.bindFramebuffer(R.READ_FRAMEBUFFER, Ho),
          me.bindFramebuffer(R.DRAW_FRAMEBUFFER, ko));
        for (let Et = 0; Et < ue; Et++)
          (st
            ...
            U !== 0
              ...
              : bt
                ? R.copyTexSubImage3D(rt, Q, Ge, Ye, at + Et, Te, Re, le, pe)
                : R.copyTexSubImage2D(rt, Q, Ge, Ye, Te, Re, le, pe));
        (me.bindFramebuffer(R.READ_FRAMEBUFFER, null),
          me.bindFramebuffer(R.DRAW_FRAMEBUFFER, null));
      } else
        bt
          ? _.isDataTexture || _.isData3DTexture
            ? R.texSubImage3D(rt, Q, Ge, Ye, at, le, pe, ue, $e, Ee, ot.data)
            : L.isCompressedArrayTexture
              ...
              : R.texSubImage3D(rt, Q, Ge, Ye, at, le, pe, ue, $e, Ee, ot)
          : _.isDataTexture
            ? R.texSubImage2D(R.TEXTURE_2D, Q, Ge, Ye, le, pe, $e, Ee, ot.data)
            : _.isCompressedTexture
              ...
              : R.texSubImage2D(R.TEXTURE_2D, Q, Ge, Ye, le, pe, $e, Ee, ot);
      (R.pixelStorei(R.UNPACK_ROW_LENGTH, ke),
        R.pixelStorei(R.UNPACK_IMAGE_HEIGHT, Rt),
        R.pixelStorei(R.UNPACK_SKIP_PIXELS, Hn),
        R.pixelStorei(R.UNPACK_SKIP_ROWS, wt),
        R.pixelStorei(R.UNPACK_SKIP_IMAGES, mi),
        Q === 0 && L.generateMipmaps && R.generateMipmap(rt),
        me.unbindTexture());
    }),
      ...
      (this.resetState = function () {
        ((O = 0), (S = 0), (v = null), me.reset(), w.reset());
      }),
      typeof __THREE_DEVTOOLS__ < "u" &&
        __THREE_DEVTOOLS__.dispatchEvent(
          new CustomEvent("observe", { detail: this }),
...
class ap extends xl {
  constructor(e, t = null) {
    (super(e, t),
      ...
      (this._lastQuaternion = new zn()),
      (this._lastTargetPosition = new F()),
      (this._quat = new zn().setFromUnitVectors(e.up, new F(0, 1, 0))),
      (this._quatInverse = this._quat.clone().invert()),
      (this._spherical = new wa()),
      (this._sphericalDelta = new wa()),
      (this._scale = 1),
      (this._panOffset = new F()),
      (this._rotateStart = new Ne()),
      (this._rotateEnd = new Ne()),
      (this._rotateDelta = new Ne()),
      (this._panStart = new Ne()),
      (this._panEnd = new Ne()),
      (this._panDelta = new Ne()),
      (this._dollyStart = new Ne()),
      (this._dollyEnd = new Ne()),
      (this._dollyDelta = new Ne()),
      ...
      (this._onPointerMove = cp.bind(this)),
      (this._onPointerDown = op.bind(this)),
      (this._onPointerUp = lp.bind(this)),
      (this._onContextMenu = xp.bind(this)),
      (this._onMouseWheel = dp.bind(this)),
      (this._onKeyDown = fp.bind(this)),
      (this._onTouchStart = pp.bind(this)),
      (this._onTouchMove = mp.bind(this)),
  ...
  update(e = null) {
    ...
    (ut.copy(t).sub(this.target),
      ut.applyQuaternion(this._quat),
      this._spherical.setFromVector3(ut),
      this.autoRotate &&
        this.state === Ze.NONE &&
    ...
    if (
      (ut.setFromSpherical(this._spherical),
      ut.applyQuaternion(this._quatInverse),
      t.copy(this.target).add(ut),
      ...
      a !== null &&
        (this.screenSpacePanning
          ...
          : (er.origin.copy(this.object.position),
            ...
            Math.abs(this.object.up.dot(er.direction)) < sp
              ? this.object.lookAt(this.target)
              : (eo.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                er.intersectPlane(eo, this.target))));
    } else if (this.object.isOrthographicCamera) {
    ...
    return (
      ...
      (this._performCursorZoom = !1),
      s ||
      this._lastPosition.distanceToSquared(this.object.position) > Kr ||
      8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > Kr ||
      this._lastTargetPosition.distanceToSquared(this.target) > Kr
        ? (this.dispatchEvent(Qa),
  ...
  _panLeft(e, t) {
    (ut.setFromMatrixColumn(t, 0),
      ut.multiplyScalar(-e),
      this._panOffset.add(ut));
  }
  _panUp(e, t) {
    (this.screenSpacePanning === !0
      ? ut.setFromMatrixColumn(t, 1)
      : (ut.setFromMatrixColumn(t, 0), ut.crossVectors(this.object.up, ut)),
      ut.multiplyScalar(e),
      this._panOffset.add(ut));
  }
  _pan(e, t) {
  ...
  _trackPointer(e) {
    ...
    (t === void 0 &&
      ((t = new Ne()), (this._pointerPositions[e.pointerId] = t)),
...
function hp(i) {
  ...
  this.state !== Ze.NONE && this.dispatchEvent(Ks);
}
function up(i) {
  switch (this.state) {
    case Ze.ROTATE:
...
async function Ep(i) {
  ...
  const u = 0.5,
    d = new cn(u, u, u),
    f = new ri({ color: 16711680 }),
    m = new Bt(d, f);
  (m.position.set(0, 5, 0), i.add(m));
  const g = new e.btVector3(u / 2, u / 2, u / 2),
    M = new e.btVector3(2, 2, 0),
    p = tr(e, g, M, 1);
  ((m.userData.physicsBody = p.body), t.addRigidBody(p.body));
  const h = [{ mesh: m, body: p.body }];
  function T(A, P, E) {
    const C = { x: 1, y: 0.5, z: 1 },
      O = new e.btVector3(C.x / 2, C.y / 2, C.z / 2),
      S = new e.btVector3(A, P, E),
      v = tr(e, O, S, 0);
    t.addRigidBody(v.body);
    const D = new cn(C.x, C.y, C.z),
      B = new ri({ color: 16711680 }),
      V = new Bt(D, B);
    (V.position.set(A, P, E), i.add(V), h.push({ mesh: V, body: v.body }));
  }
  function y(A, P, E) {
    const C = { x: 1, y: 0.5, z: 1 },
      O = new e.btVector3(C.x / 2, C.y / 2, C.z / 2),
    ...
    t.addRigidBody(v.body);
    const D = new cn(C.x, C.y, C.z),
      B = new ri({ color: 65280 }),
      V = new Bt(D, B);
    (V.position.set(A, P, E),
      (V.userData.physicsBody = v.body),
      i.add(V),
      h.push({ mesh: V, body: v.body }));
  }
  return (
    T(0, 0.25, -1),
    T(0, 0.25, 1),
    ...
    y(0, 0.1, 0),
    {
      ...
      bodies: h,
      update(A) {
        t.stepSimulation(A, 10);
        for (const P of h) {
          const E = P.body.getMotionState();
          if (E) {
            const C = new e.btTransform();
            E.getWorldTransform(C);
            const O = C.getOrigin(),
              S = C.getRotation();
            (P.mesh.position.set(O.x(), O.y(), O.z()),
...
const bi = await Io(),
  No = new al(),
  Zs = new Ft(75, window.innerWidth / window.innerHeight, 0.1, 1e3),
  yp = 4;
Zs.position.z = yp;
const xr = new rp();
xr.setSize(window.innerWidth, window.innerHeight);
document.body.appendChild(xr.domElement);
const Tp = new ap(Zs, xr.domElement),
  Ap = new ml();
let jt = null;
Ep(No).then((i) => {
  jt = i;
});
const zt = { forward: !1, backward: !1, left: !1, right: !1 };
...
function Rp() {
  ...
  !no &&
    ...
    (console.log(e, n),
    (no = !0),
    jt.bodies[0].mesh.material.color.setHex(65280),
    console.log("WIN!"));
}
function wp() {
  if (!jt) return;
  const i = jt.bodies[0].body,
    e = jt.bodies[0].mesh,
    t = e.position.x,
    n = e.position.z;
  console.log(t, n);
  const r = new bi.btVector3(0, 0, 0),
    s = 0.5;
  (zt.forward && r.op_add(new bi.btVector3(0, s, 0)),
    zt.backward && r.op_add(new bi.btVector3(0, -s, 0)),
    zt.left && r.op_add(new bi.btVector3(-s, 0, 0)),
    zt.right && r.op_add(new bi.btVector3(s, 0, 0)),
    i.applyCentralImpulse(r));
}
function Fo() {
  requestAnimationFrame(Fo);
  const i = Ap.getDelta();
  (jt && typeof jt.update == "function" && jt.update(i),
    Tp.update(),
    wp(),
    Rp(),
    xr.render(No, Zs));
