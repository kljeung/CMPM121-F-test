...
function Pc() {
  const i = {
        ...
        return (
          this.enabled === !1 ||
            ...
            (this.spaces[s].transfer === Ke &&
              ((r.r = an(r.r)), (r.g = an(r.g)), (r.b = an(r.b))),
      ...
      getTransfer: function (r) {
        return r === gn ? rr : this.spaces[r].transfer;
      },
  ...
  static sRGBToLinear(e) {
    if (
      ...
      const r = n.getImageData(0, 0, e.width, e.height),
        s = r.data;
      for (let a = 0; a < s.length; a++) s[a] = an(s[a] / 255) * 255;
      ...
      return (
        E > w && E > D
          ? E < 0.01
            ...
            : ((n = Math.sqrt(E)), (r = y / n), (s = C / n))
          : w > D
            ? w < 0.01
              ? ((n = 0.707106781), (r = 0), (s = 0.707106781))
              : ((r = Math.sqrt(w)), (n = y / r), (s = z / r))
            : D < 0.01
              ? ((n = 0.707106781), (r = 0.707106781), (s = 0))
              : ((s = Math.sqrt(D)), (n = C / s), (r = z / s)),
        this.set(n, r, s, t),
        this
      );
    }
...
class Ic extends Bn {
  ...
  copy(e) {
    ...
    for (let t = 0, n = e.textures.length; t < n; t++) {
      ...
      this.textures[t].source = new Hs(r);
    }
    return (
...
class Ai {
  ...
  intersectsTriangle(e) {
    ...
    (this.getCenter(pi),
      Di.subVectors(this.max, pi),
      Hn.subVectors(e.a, pi),
      kn.subVectors(e.b, pi),
      Wn.subVectors(e.c, pi),
      un.subVectors(kn, Hn),
      dn.subVectors(Wn, kn),
      Tn.subVectors(Hn, Wn));
    let t = [
    ...
    return !Sr(t, Hn, kn, Wn, Di) ||
      ((t = [1, 0, 0, 0, 1, 0, 0, 0, 1]), !Sr(t, Hn, kn, Wn, Di))
      ? !1
      : (Li.crossVectors(un, dn),
        (t = [Li.x, Li.y, Li.z]),
        Sr(t, Hn, kn, Wn, Di));
  }
  clampPoint(e, t) {
...
class uo {
  ...
  distanceSqToSegment(e, t, n, r) {
    ...
    return (
      ...
      r && r.copy(Er).addScaledVector(Ui, f),
      m
    );
  }
  intersectSphere(e, t) {
  ...
  intersectTriangle(e, t, n, r, s) {
    (yr.subVectors(t, e), Ii.subVectors(n, e), Tr.crossVectors(yr, Ii));
    ...
    if (l < 0) return null;
    const c = o * this.direction.dot(yr.cross(fn));
...
class dt {
  ...
  extractRotation(e) {
    const t = this.elements,
      n = e.elements,
      r = 1 / Xn.setFromMatrixColumn(e, 0).length(),
      s = 1 / Xn.setFromMatrixColumn(e, 1).length(),
  ...
  lookAt(e, t, n) {
    ...
    return (
      ...
      Ct.normalize(),
      pn.crossVectors(n, Ct),
      pn.lengthSq() === 0 &&
        (Math.abs(n.z) === 1 ? (Ct.x += 1e-4) : (Ct.z += 1e-4),
        Ct.normalize(),
        pn.crossVectors(n, Ct)),
      pn.normalize(),
      Ni.crossVectors(Ct, pn),
      (r[0] = pn.x),
      (r[4] = Ni.x),
      (r[8] = Ct.x),
      (r[1] = pn.y),
  ...
  multiplyMatrices(e, t) {
    ...
    return (
      (s[0] = a * y + o * v + l * q + c * H),
      (s[4] = a * C + o * P + l * W + c * ne),
      (s[8] = a * z + o * B + l * K + c * se),
      (s[12] = a * S + o * G + l * J + c * Se),
      (s[1] = u * y + d * v + f * q + m * H),
      (s[5] = u * C + d * P + f * W + m * ne),
      (s[9] = u * z + d * B + f * K + m * se),
      (s[13] = u * S + d * G + f * J + m * Se),
      (s[2] = g * y + M * v + p * q + h * H),
      (s[6] = g * C + M * P + p * W + h * ne),
      (s[10] = g * z + M * B + p * K + h * se),
      (s[14] = g * S + M * G + p * J + h * Se),
      (s[3] = T * y + E * v + w * q + D * H),
      (s[7] = T * C + E * P + w * W + D * ne),
      (s[11] = T * z + E * B + w * K + D * se),
      (s[15] = T * S + E * G + w * J + D * Se),
      this
    );
  }
  multiplyScalar(e) {
  ...
  invert() {
    const e = this.elements,
      ...
      w = u * M * c - g * d * c + g * o * m - a * M * m - u * o * h + a * d * h,
  ...
  decompose(e, t, n) {
    ...
    const a = Xn.set(r[4], r[5], r[6]).length(),
      o = Xn.set(r[8], r[9], r[10]).length();
  ...
  makePerspective(e, t, n, r, s, a, o = Yt, l = !1) {
    ...
    else if (o === sr) ((g = -a / (a - s)), (M = (-a * s) / (a - s)));
    else
      throw new Error(
...
class Lt extends Bn {
  ...
  lookAt(e, t, n) {
    ...
    (this.updateWorldMatrix(!0, !1),
      ...
      this.isCamera || this.isLight
        ? jt.lookAt(xi, Fi, this.up)
        : jt.lookAt(Fi, xi, this.up),
  ...
  getWorldQuaternion(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(xi, e, Vc),
      e
    );
  }
  getWorldScale(e) {
    return (
      this.updateWorldMatrix(!0, !1),
      this.matrixWorld.decompose(xi, Gc, e),
      e
    );
  }
  getWorldDirection(e) {
...
class Ht {
  ...
  static getBarycoord(e, t, n, r, s) {
    (Gt.subVectors(r, t), $t.subVectors(n, t), Rr.subVectors(e, t));
    const a = Gt.dot(Gt),
      o = Gt.dot($t),
      l = Gt.dot(Rr),
      c = $t.dot($t),
  ...
  static getInterpolation(e, t, n, r, s, a, o, l) {
    return this.getBarycoord(e, t, n, r, Jt) === null
      ...
      : (l.setScalar(0),
        ...
        l.addScaledVector(a, Jt.y),
        l.addScaledVector(o, Jt.z),
        l);
  }
  static getInterpolatedAttribute(e, t, n, r, s, a) {
    return (
      ...
      Lr.fromBufferAttribute(e, n),
      Ur.fromBufferAttribute(e, r),
      a.setScalar(0),
      a.addScaledVector(Dr, s.x),
      a.addScaledVector(Lr, s.y),
      a.addScaledVector(Ur, s.z),
      a
    );
  }
  static isFrontFacing(e, t, n, r) {
    return (Gt.subVectors(n, t), $t.subVectors(e, t), Gt.cross($t).dot(r) < 0);
  }
  set(e, t, n) {
...
class je {
  ...
  setHSL(e, t, n, r = We.workingColorSpace) {
    if (((e = wc(e, 1)), (t = Oe(t, 0, 1)), (n = Oe(n, 0, 1)), t === 0))
...
class cr extends Bn {
  ...
  toJSON(e) {
    ...
    ((n.uuid = this.uuid),
      ...
      this.blendSrc !== Xr && (n.blendSrc = this.blendSrc),
...
class bn extends Bn {
  ...
  setFromPoints(e) {
    ...
    if (t === void 0) {
      ...
      this.setAttribute("position", new In(n, 3));
    } else {
      ...
      if ((Pt.setFromBufferAttribute(e), t))
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          (_i.setFromBufferAttribute(o),
            this.morphTargetsRelative
              ? (mt.addVectors(Pt.min, _i.min),
                Pt.expandByPoint(mt),
                mt.addVectors(Pt.max, _i.max),
                Pt.expandByPoint(mt))
              : (Pt.expandByPoint(_i.min), Pt.expandByPoint(_i.max)));
        }
      Pt.getCenter(n);
      let r = 0;
        ...
        for (let s = 0, a = t.length; s < a; s++) {
          ...
          for (let c = 0, u = o.count; c < u; c++)
            (mt.fromBufferAttribute(o, c),
              l && (jn.fromBufferAttribute(e, c), mt.add(jn)),
              (r = Math.max(r, n.distanceToSquared(mt))));
        }
  ...
  computeTangents() {
    ...
    function C(z) {
      ...
      (E.copy(S),
        ...
        w.crossVectors(y, S));
      const P = w.dot(l[z]) < 0 ? -1 : 1;
      a.setXYZW(z, E.x, E.y, E.z, P);
    }
    for (let z = 0, S = T.length; z < S; ++z) {
      const v = T[z],
        P = v.start,
...
class ln extends Lt {
    ...
    if (s && o) {
      ...
      for (let l = 0, c = s.length; l < c; l++) {
        const u = o[l],
          d = s[l];
        u !== 0 &&
          (Fr.fromBufferAttribute(d, e),
          a ? ki.addScaledVector(Fr, u) : ki.addScaledVector(Fr.sub(t), u));
      }
      t.add(ki);
    }
    return t;
  ...
  raycast(e, t) {
    ...
    r !== void 0 &&
      ...
      !(
        zi.containsPoint(Rn.origin) === !1 &&
        (Rn.intersectSphere(zi, Sa) === null ||
          Rn.origin.distanceToSquared(Sa) > (e.far - e.near) ** 2)
      ) &&
        (Ma.copy(s).invert(),
        Rn.copy(e.ray).applyMatrix4(Ma),
...
function Yc(i, e, t, n, r, s, a, o) {
  ...
  if (
    (e.side === At
      ...
      : (l = n.intersectTriangle(r, s, a, e.side === Sn, o)),
    l === null)
  )
    return null;
...
function Xi(i, e, t, n, r, s, a, o, l, c) {
  ...
  if (u) {
    const d = new F();
    (Ht.getBarycoord(ba, Vi, Gi, Hi, d),
      r && (u.uv = Ht.getInterpolatedAttribute(r, o, l, c, d, new Ne())),
      s && (u.uv1 = Ht.getInterpolatedAttribute(s, o, l, c, d, new Ne())),
      a &&
        ((u.normal = Ht.getInterpolatedAttribute(a, o, l, c, d, new F())),
        u.normal.dot(n.direction) > 0 && u.normal.multiplyScalar(-1)));
    const f = { a: o, b: l, c, normal: new F(), materialIndex: 0 };
    (Ht.getNormal(Vi, Gi, Hi, f.normal), (u.face = f), (u.barycoord = d));
  }
  return u;
}
class hi extends bn {
  constructor(e = 1, t = 1, n = 1, r = 1, s = 1, a = 1) {
    ...
    (g("z", "y", "x", -1, -1, n, t, e, a, s, 0),
      ...
      this.setIndex(l),
      this.setAttribute("position", new In(c, 3)),
      this.setAttribute("normal", new In(u, 3)),
      this.setAttribute("uv", new In(d, 2)));
    function g(M, p, h, T, E, w, D, y, C, z, S) {
      const v = w / C,
        P = D / z,
        B = w / 2,
        G = D / 2,
...
class Ft extends go {
  ...
  getEffectiveFOV() {
    return Ls * 2 * Math.atan(Math.tan(tr * 0.5 * this.fov) / this.zoom);
  }
  getFilmWidth() {
  ...
  updateProjectionMatrix() {
    const e = this.near;
    let t = (e * Math.tan(tr * 0.5 * this.fov)) / this.zoom,
      n = 2 * t,
      r = this.aspect * n,
      s = -0.5 * r;
    const a = this.view;
...
class $c extends Lt {
  constructor(e, t, n) {
    ...
    const r = new Ft($n, Jn, e, t);
    ((r.layers = this.layers), this.add(r));
    const s = new Ft($n, Jn, e, t);
    ((s.layers = this.layers), this.add(s));
    const a = new Ft($n, Jn, e, t);
    ((a.layers = this.layers), this.add(a));
    const o = new Ft($n, Jn, e, t);
    ((o.layers = this.layers), this.add(o));
    const l = new Ft($n, Jn, e, t);
    ((l.layers = this.layers), this.add(l));
    const c = new Ft($n, Jn, e, t);
...
class Jc extends On {
  ...
  fromEquirectangularTexture(e, t) {
    ...
    const a = new ln(r, s),
      o = t.minFilter;
    return (
      t.minFilter === Un && (t.minFilter = Ot),
      new $c(1, 10, this).update(e, a),
      (t.minFilter = o),
      a.geometry.dispose(),
      a.material.dispose(),
      this
...
class _n {
  ...
  setFromCoplanarPoints(e, t, n) {
    const r = Br.subVectors(n, t).cross(nl.subVectors(e, t)).normalize();
...
class Mo {
  ...
  setFromProjectionMatrix(e, t = Yt, n = !1) {
    ...
    if (
      ...
      (r[4].setComponents(l, f, p, w).normalize(),
        r[5].setComponents(c - l, m - f, h - p, D - w).normalize());
    else if (
      (r[4].setComponents(c - l, m - f, h - p, D - w).normalize(), t === Yt)
    )
      r[5].setComponents(c + l, m + f, h + p, D + w).normalize();
    else if (t === sr) r[5].setComponents(l, f, p, w).normalize();
    else
      throw new Error(
  ...
  intersectsBox(e) {
    ...
    for (let n = 0; n < 6; n++) {
      const r = t[n];
      if (
        ((qi.x = r.normal.x > 0 ? e.max.x : e.min.x),
        (qi.y = r.normal.y > 0 ? e.max.y : e.min.y),
        (qi.z = r.normal.z > 0 ? e.max.z : e.min.z),
        r.distanceToPoint(qi) < 0)
      )
        return !1;
    }
    return !0;
...
class So extends St {
  constructor(e, t, n = Nn, r, s, a, o = Dt, l = Dt, c, u = bi, d = 1) {
    if (u !== bi && u !== Ei)
      throw new Error(
  ...
  copy(e) {
    return (
      super.copy(e),
      (this.source = new Hs(Object.assign({}, e.image))),
...
class lr extends bn {
  constructor(e = 1, t = 1, n = 1, r = 1) {
    ...
    for (let h = 0; h < u; h++) {
      ...
      for (let E = 0; E < c; E++) {
        const w = E * d - s;
        (g.push(w, -T, 0), M.push(0, 0, 1), p.push(E / o), p.push(1 - h / l));
      }
    }
    for (let h = 0; h < l; h++)
      for (let T = 0; T < o; T++) {
    ...
    (this.setIndex(m),
      this.setAttribute("position", new In(g, 3)),
      this.setAttribute("normal", new In(M, 3)),
      this.setAttribute("uv", new In(p, 2)));
  }
  copy(e) {
    return (
      super.copy(e),
...
#endif`,
  bl = `vec3 transformed = vec3( position );
#ifdef USE_ALPHAHASH
	vPosition = vec3( position );
#endif`,
  El = `vec3 objectNormal = vec3( normal );
#ifdef USE_TANGENT
...
#endif`,
  Ol = `vec3 transformedNormal = objectNormal;
#ifdef USE_TANGENT
...
IncidentLight directLight;
  ...
  dh = `#if defined( RE_IndirectDiffuse )
	...
	#endif
#endif`,
  fh = `#if defined( RE_IndirectDiffuse )
	RE_IndirectDiffuse( irradiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif
#if defined( RE_IndirectSpecular )
	RE_IndirectSpecular( radiance, iblIrradiance, clearcoatRadiance, geometryPosition, geometryNormal, geometryViewDir, geometryClearcoatNormal, material, reflectedLight );
#endif`,
  ph = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
	gl_FragDepth = vIsPerspective == 0.0 ? gl_FragCoord.z : log2( vFragDepth ) * logDepthBufFC * 0.5;
#endif`,
  mh = `#if defined( USE_LOGARITHMIC_DEPTH_BUFFER )
	uniform float logDepthBufFC;
	varying float vFragDepth;
	varying float vIsPerspective;
#endif`,
  xh = `#ifdef USE_LOGARITHMIC_DEPTH_BUFFER
	varying float vFragDepth;
	varying float vIsPerspective;
#endif`,
  _h = `#ifdef USE_LOGARITHMIC_DEPTH_BUFFER
...
#endif`,
  Eh = `#ifdef USE_METALNESSMAP
	uniform sampler2D metalnessMap;
#endif`,
  yh = `#ifdef USE_INSTANCING_MORPH
...
#endif`,
  wh = `#ifdef USE_MORPHTARGETS
	transformed *= morphTargetBaseInfluence;
	for ( int i = 0; i < MORPHTARGETS_COUNT; i ++ ) {
		if ( morphTargetInfluences[ i ] != 0.0 ) transformed += getMorph( gl_VertexID, i, 0 ).xyz * morphTargetInfluences[ i ];
	}
#endif`,
  Ch = `float faceDirection = gl_FrontFacing ? 1.0 : - 1.0;
#ifdef FLAT_SHADED
...
#endif`,
  Hh = `vec4 mvPosition = vec4( transformed, 1.0 );
#ifdef USE_BATCHING
...
gl_Position = projectionMatrix * mvPosition;`,
...
#endif`,
  Yh = `#ifdef USE_ROUGHNESSMAP
	uniform sampler2D roughnessMap;
#endif`,
  qh = `#if NUM_SPOT_LIGHT_COORDS > 0
  ...
  Kh = `#if NUM_SPOT_LIGHT_COORDS > 0
	...
	#endif
#endif`,
  Zh = `#if ( defined( USE_SHADOWMAP ) && ( NUM_DIR_LIGHT_SHADOWS > 0 || NUM_POINT_LIGHT_SHADOWS > 0 ) ) || ( NUM_SPOT_LIGHT_COORDS > 0 )
...
void main() {
  ...
  Ie = {
    alphahash_fragment: dl,
    alphahash_pars_fragment: fl,
    ...
    morphnormal_vertex: Ah,
    morphtarget_pars_vertex: Rh,
    morphtarget_vertex: wh,
    normal_fragment_begin: Ch,
    normal_fragment_maps: Ph,
    normal_pars_fragment: Dh,
    normal_pars_vertex: Lh,
    normal_vertex: Uh,
    normalmap_pars_fragment: Ih,
    clearcoat_normal_fragment_begin: Nh,
    clearcoat_normal_fragment_maps: Fh,
    clearcoat_pars_fragment: Oh,
    iridescence_pars_fragment: Bh,
    opaque_fragment: zh,
    packing: Vh,
    premultiplied_alpha_fragment: Gh,
    project_vertex: Hh,
    dithering_fragment: kh,
    dithering_pars_fragment: Wh,
    ...
    backgroundCube_frag: pu,
    cube_vert: mu,
    cube_frag: xu,
    depth_vert: _u,
    depth_frag: gu,
    distanceRGBA_vert: vu,
    distanceRGBA_frag: Mu,
    equirect_vert: Su,
    equirect_frag: bu,
    linedashed_vert: Eu,
    linedashed_frag: yu,
...
function Yu(i, e, t, n, r, s, a) {
  ...
  let l = s === !0 ? 0 : 1,
    ...
    m = null;
  function g(E) {
    let w = E.isScene === !0 ? E.background : null;
    return (
      w && w.isTexture && (w = (E.backgroundBlurriness > 0 ? t : e).get(w)),
      w
    );
  }
  function M(E) {
    let w = !1;
    const D = g(E);
    D === null ? h(o, l) : D && D.isColor && (h(D, 1), (w = !0));
  ...
  function p(E, w) {
    const D = g(w);
    D && (D.isCubeTexture || D.mapping === or)
      ? (u === void 0 &&
          ((u = new ln(
            new hi(1, 1, 1),
            new hn({
              name: "BackgroundCubeMaterial",
              uniforms: ci(Xt.backgroundCube.uniforms),
          ...
          (u.onBeforeRender = function (y, C, z) {
        ...
        (c === void 0 &&
          ((c = new ln(
            ...
            new hn({
              ...
              uniforms: ci(Xt.background.uniforms),
  ...
  function h(E, w) {
    (E.getRGB(Ki, _o(i)), n.buffers.color.setClear(Ki.r, Ki.g, Ki.b, w, a));
  }
  function T() {
...
function qu(i, e) {
  ...
  function f(v) {
    const P = [],
      B = [],
      G = [];
    for (let q = 0; q < t; q++) ((P[q] = 0), (B[q] = 0), (G[q] = 0));
    return {
      geometry: null,
      program: null,
      wireframe: !1,
  ...
  function g(v, P, B, G) {
    ...
    ((s.attributes = q), (s.attributesNum = K), (s.index = G));
  }
  function M() {
    const v = s.newAttributes;
    for (let P = 0, B = v.length; P < B; P++) v[P] = 0;
  }
  function p(v) {
    h(v, 0);
  }
  function h(v, P) {
    ...
    ((B[v] = 1),
      ...
      q[v] !== P && (i.vertexAttribDivisor(v, P), (q[v] = P)));
  }
  function T() {
    const v = s.newAttributes,
      P = s.enabledAttributes;
    for (let B = 0, G = P.length; B < G; B++)
      P[B] !== v[B] && (i.disableVertexAttribArray(B), (P[B] = 0));
  }
  function E(v, P, B, G, q, W, K) {
    K === !0
      ? i.vertexAttribIPointer(v, P, B, q, W)
      : i.vertexAttribPointer(v, P, B, G, q, W);
  }
  function w(v, P, B, G) {
    M();
        ...
        if (
          (ne === void 0 &&
            (J === "instanceMatrix" &&
              v.instanceMatrix &&
              (ne = v.instanceMatrix),
            J === "instanceColor" && v.instanceColor && (ne = v.instanceColor)),
          ne !== void 0)
        ) {
          const se = ne.normalized,
            Se = ne.itemSize,
            He = e.get(ne);
          ...
          const Xe = He.buffer,
            ...
            X = Je === i.INT || Je === i.UNSIGNED_INT || ne.gpuType === Ns;
          if (ne.isInterleavedBufferAttribute) {
            ...
            if (ne.isInstancedBufferAttribute) {
              for (let j = 0; j < H.locationSize; j++)
                h(H.location + j, ne.meshPerAttribute);
              v.isInstancedMesh !== !0 &&
                G._maxInstanceCount === void 0 &&
                (G._maxInstanceCount = ne.meshPerAttribute * ne.count);
  ...
  function D() {
    ...
    for (const v in n) {
      ...
      for (const B in P) {
        const G = P[B];
        for (const q in G) (u(G[q].object), delete G[q]);
        delete P[B];
      }
      delete n[v];
    }
...
function Zu(i, e, t, n) {
  ...
  const d = t.logarithmicDepthBuffer === !0,
    ...
    w = i.getParameter(i.MAX_FRAGMENT_UNIFORM_VECTORS),
    D = g > 0,
...
function $u(i) {
  let e = new WeakMap();
  function t(a, o) {
    return (o === es ? (a.mapping = si) : o === ts && (a.mapping = ai), a);
  }
  function n(a) {
    if (a && a.isTexture) {
      const o = a.mapping;
...
class Ca {
  ...
  fromScene(e, t = 0, n = 0.1, r = 100, s = {}) {
    const { size: a = 256, position: o = Qu } = s;
  ...
  _allocateTargets() {
    ...
    if (
      ...
      (this._pingPongRenderTarget !== null && this._dispose(),
        (this._pingPongRenderTarget = Pa(e, t, n)));
      ...
      (({
        ...
        (this._blurMaterial = nd(s, e, t)));
    }
    return r;
  }
  _compileMaterial(e) {
    const t = new ln(new bn(), e);
  ...
  _textureToCubeUV(e, t) {
    ...
    r
      ? (this._cubemapMaterial === null && (this._cubemapMaterial = La()),
    ...
    (Qn(t, 0, 0, 3 * l, 2 * l), n.setRenderTarget(t), n.render(a, gi));
  }
  _applyPMREM(e) {
  ...
  _applyGGXFilter(e, t, n) {
    ...
    if (this._ggxMaterial === null) {
      const T = 3 * Math.max(this._cubeSize, 16),
        E = 4 * this._cubeSize;
      this._ggxMaterial = td(this._lodMax, T, E);
    }
  ...
  _halfBlur(e, t, n, r, s, a, o) {
    ...
    const w = this._sizeLods[r],
      D = 3 * w * (r > E - vn ? r - E + vn : 0),
      y = 4 * (this._cubeSize - w);
    (Qn(t, D, y, 3 * w, 2 * w), l.setRenderTarget(t), l.render(d, gi));
  }
}
function ed(i) {
  const e = [],
    ...
    n = [];
  let r = i;
  const s = i - vn + 1 + Ra.length;
  for (let a = 0; a < s; a++) {
    const o = Math.pow(2, r);
    e.push(o);
    let l = 1 / o;
    (a > i - vn ? (l = Ra[a - i + vn - 1]) : a === 0 && (l = 0), t.push(l));
    const c = 1 / (o - 2),
      u = -c,
      d = 1 + c,
    ...
    (D.setAttribute("position", new qt(T, M)),
      ...
      D.setAttribute("faceIndex", new qt(w, h)),
      n.push(new ln(D, null)),
      r > vn && r--);
  }
...
function rd(i) {
  ...
  return {
    ...
    get: function (n) {
      const r = t(n);
      return (
        r === null && yi("WebGLRenderer: " + n + " extension not supported."),
        r
      );
    },
  };
...
function cd(i, e, t) {
  ...
  function s(a, o, l) {
    ...
    if (f === void 0 || f.count !== d) {
      let v = function () {
        (z.dispose(), n.delete(o), o.removeEventListener("dispose", v));
      };
      var m = v;
      ...
      let w = 0;
      (g === !0 && (w = 1), M === !0 && (w = 2), p === !0 && (w = 3));
      let D = o.attributes.position.count * w,
        y = 1;
      D > e.maxTextureSize &&
        ((y = Math.ceil(D / e.maxTextureSize)), (D = e.maxTextureSize));
      const C = new Float32Array(D * y * 4 * d),
        z = new ho(C, D, y, d);
      ((z.type = rn), (z.needsUpdate = !0));
      const S = w * 4;
      for (let P = 0; P < d; P++) {
        const B = h[P],
          G = T[P],
        ...
        for (let K = 0; K < B.count; K++) {
          ...
          (g === !0 &&
            ...
            p === !0 &&
              ...
              (C[W + J + 9] = r.y),
              (C[W + J + 10] = r.z),
              (C[W + J + 11] = q.itemSize === 4 ? r.w : 1)));
        }
      }
      ((f = { count: d, texture: z, size: new Ne(D, y) }),
        n.set(o, f),
...
function ui(i, e, t) {
  ...
  const r = e * t;
  let s = Ia[r];
  if ((s === void 0 && ((s = new Float32Array(r)), (Ia[r] = s)), e !== 0)) {
    n.toArray(s, 0);
...
function pd(i, e) {
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (Ba.set(n), i.uniformMatrix2fv(this.addr, !1, Ba), pt(t, n));
  }
}
function md(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (Oa.set(n), i.uniformMatrix3fv(this.addr, !1, Oa), pt(t, n));
  }
}
function xd(i, e) {
  const t = this.cache,
  ...
  if (n === void 0) {
    ...
    if (ft(t, n)) return;
    (Fa.set(n), i.uniformMatrix4fv(this.addr, !1, Fa), pt(t, n));
  }
}
function _d(i, e) {
  const t = this.cache;
...
function Xd(i, e, t) {
  ...
  for (let a = 0; a !== r; ++a) t.setTexture2D(e[a] || yo, s[a]);
}
function Yd(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = ur(t, r);
  ft(n, s) || (i.uniform1iv(this.addr, s), pt(n, s));
  for (let a = 0; a !== r; ++a) t.setTexture3D(e[a] || Ao, s[a]);
}
function qd(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = ur(t, r);
  ft(n, s) || (i.uniform1iv(this.addr, s), pt(n, s));
  for (let a = 0; a !== r; ++a) t.setTextureCube(e[a] || Ro, s[a]);
}
function Kd(i, e, t) {
  const n = this.cache,
    r = e.length,
    s = ur(t, r);
  ft(n, s) || (i.uniform1iv(this.addr, s), pt(n, s));
  for (let a = 0; a !== r; ++a) t.setTexture2DArray(e[a] || To, s[a]);
}
function Zd(i) {
  switch (i) {
    case 5126:
...
function Qd(i, e, t) {
  ...
  for (kr.lastIndex = 0; ; ) {
    ...
    if ((l && (o = o | 0), c === void 0 || (c === "[" && a + 2 === r))) {
      za(t, c === void 0 ? new jd(o, i, e) : new $d(o, i, e));
      break;
    } else {
      let d = t.map[o];
      (d === void 0 && ((d = new Jd(o)), za(t, d)), (t = d));
    }
  }
}
class nr {
...
const Ga = new Ue();
function rf(i) {
  We._getMatrix(Ga, We.workingColorSpace, i);
...
const Zi = new F();
function of() {
  We.getLuminanceCoefficients(Zi);
  const i = Zi.x.toFixed(4),
    e = Zi.y.toFixed(4),
    t = Zi.z.toFixed(4);
  return [
  ...
  return (
    i.shadowMapType === Ja
      ...
      : i.shadowMapType === Vo
        ...
        : i.shadowMapType === en && (e = "SHADOWMAP_TYPE_VSM"),
    e
  );
}
function _f(i) {
...
`)),
      (h = [
        ...
        t.toneMapping !== Mn ? Ie.tonemapping_pars_fragment : "",
        t.toneMapping !== Mn ? af("toneMapping", t.toneMapping) : "",
...
` +
  ...
  const E = T + p + a,
    w = T + h + o,
    D = Va(r, r.VERTEX_SHADER, E),
    y = Va(r, r.FRAGMENT_SHADER, w);
  (r.attachShader(M, D),
    r.attachShader(M, y),
...
` +
        ...
        W !== ""
          ? De("WebGLProgram: Program Info Log:", W)
          : (K === "" || J === "") && (ne = !1);
      ne &&
        (P.diagnostics = {
          runnable: H,
    ...
    (r.deleteShader(D), r.deleteShader(y), (z = new nr(r, M)), (S = hf(r, M)));
  }
  let z;
  ...
  return (
    (this.isReady = function () {
      return (v === !1 && (v = r.getProgramParameter(M, ef)), v);
    }),
...
function Tf(i, e, t, n, r, s, a) {
  ...
  function p(S, v, P, B, G) {
    const q = B.fog,
      W = G.geometry,
      K = S.isMeshStandardMaterial ? B.environment : null,
      J = (S.isMeshStandardMaterial ? t : e).get(S.envMap || K),
      H = J && J.mapping === or ? J.image.height : null,
      ne = g[S.type];
    S.precision !== null &&
    ...
    let He = 0;
    (W.morphAttributes.position !== void 0 && (He = 1),
      W.morphAttributes.normal !== void 0 && (He = 2),
      W.morphAttributes.color !== void 0 && (He = 3));
    let Xe, Je, Qe, X;
    if (ne) {
      const Ye = Xt[ne];
    ...
    const j = i.getRenderTarget(),
      ...
      te = k && !!S.sheenColorMap,
      Ae = k && !!S.sheenRoughnessMap,
      ye = !!S.specularMap,
      he = !!S.specularColorMap,
      we = !!S.specularIntensityMap,
      R = Z && !!S.transmissionMap,
      ce = Z && !!S.thicknessMap,
      ie = !!S.gradientMap,
      re = !!S.alphaMap,
      Q = S.alphaTest > 0,
    ...
    const tt = {
      ...
      normalMapTangentSpace: Ve && S.normalMapType === _c,
      metalnessMap: it,
      roughnessMap: Me,
      anisotropy: Pe,
      anisotropyMap: V,
      ...
      transmissionMapUv: R && M(S.transmissionMap.channel),
      thicknessMapUv: ce && M(S.thicknessMap.channel),
      alphaMapUv: re && M(S.alphaMap.channel),
      vertexTangents: !!W.attributes.tangent && (Ve || Pe),
      vertexColors: S.vertexColors,
      vertexAlphas:
        S.vertexColors === !0 &&
        !!W.attributes.color &&
        W.attributes.color.itemSize === 4,
      pointsUvs: G.isPoints === !0 && !!W.attributes.uv && (Be || re),
      fog: !!q,
      useFog: S.fog === !0,
  ...
  function h(S) {
    ...
    if (
      ...
      for (const P in S.defines) (v.push(P), v.push(S.defines[P]));
    return (
  ...
  function D(S, v) {
    ...
    return (P === void 0 && ((P = new Sf(i, v, S, s)), u.push(P)), P);
  }
  function y(S) {
    if (--S.usedTimes === 0) {
      const v = u.indexOf(S);
...
function Ka() {
  ...
  function c(d, f) {
    (t.length > 1 && t.sort(d || Rf),
      n.length > 1 && n.sort(f || qa),
      r.length > 1 && r.sort(f || qa));
  }
  function u() {
...
function Uf(i) {
  ...
  function o(c) {
    ...
    for (let S = 0, v = c.length; S < v; S++) {
      ...
      if (P.isAmbientLight) ((u += B.r * G), (d += B.g * G), (f += B.b * G));
        ...
        (K.position.setFromMatrixPosition(P.matrixWorld),
          K.color.copy(B).multiplyScalar(G),
          (K.distance = q),
        ...
        if (
          (P.map &&
            ((n.spotLightMap[D] = P.map),
            D++,
            J.updateMatrices(P),
            P.castShadow && y++),
          (n.spotLightMatrix[M] = J.matrix),
          P.castShadow)
        ) {
          const H = t.get(P);
          ((H.shadowIntensity = J.intensity),
        ...
        const K = e.get(P);
        (K.skyColor.copy(P.color).multiplyScalar(G),
          K.groundColor.copy(P.groundColor).multiplyScalar(G),
          (n.hemi[h] = K),
          h++);
      }
    }
    ...
    (z.directionalLength !== m ||
      ...
      (n.spotLightMatrix.length = w + D - y),
    ...
    for (let h = 0, T = c.length; h < T; h++) {
      ...
      if (E.isDirectionalLight) {
        ...
        (w.direction.setFromMatrixPosition(E.matrixWorld),
          ...
          w.direction.sub(r),
          w.direction.transformDirection(p),
          d++);
      } else if (E.isSpotLight) {
        const w = n.spot[m];
        (w.position.setFromMatrixPosition(E.matrixWorld),
          w.position.applyMatrix4(p),
          w.direction.setFromMatrixPosition(E.matrixWorld),
          r.setFromMatrixPosition(E.target.matrixWorld),
          w.direction.sub(r),
          w.direction.transformDirection(p),
...
function Of(i, e, t) {
  ...
  this.render = function (y, C, z) {
    ...
    (B.setBlending(sn),
      ...
      B.setScissorTest(!1));
    const G = h !== en && this.type === en,
      q = h === en && this.type !== en;
    for (let W = 0, K = y.length; W < K; W++) {
      const J = y[W],
        H = J.shadow;
      if (H === void 0) {
        De("WebGLShadowMap:", J, "has no shadow.");
        continue;
      }
      if (H.autoUpdate === !1 && H.needsUpdate === !1) continue;
      r.copy(H.mapSize);
      const ne = H.getFrameExtents();
      if (
        (r.multiply(ne),
        s.copy(H.mapSize),
        (r.x > u || r.y > u) &&
          (r.x > u &&
            ((s.x = Math.floor(u / ne.x)),
            (r.x = s.x * ne.x),
            (H.mapSize.x = s.x)),
          r.y > u &&
            ((s.y = Math.floor(u / ne.y)),
            (r.y = s.y * ne.y),
            (H.mapSize.y = s.y))),
        H.map === null || G === !0 || q === !0)
      ) {
        const Se = this.type !== en ? { minFilter: Dt, magFilter: Dt } : {};
      ...
      for (let Se = 0; Se < se; Se++) {
        ...
        (a.set(s.x * He.x, s.y * He.y, s.x * He.z, s.y * He.w),
          B.viewport(a),
          H.updateMatrices(J, Se),
          (n = H.getFrustum()),
          w(C, z, H.camera, J, this.type));
      }
      (H.isPointLightShadow !== !0 && this.type === en && T(H, z),
        (H.needsUpdate = !1));
    }
    ((h = this.type), (p.needsUpdate = !1), i.setRenderTarget(S, v, P));
  };
  function T(y, C) {
    const z = e.update(M);
    (f.defines.VSM_SAMPLES !== y.blurSamples &&
      ...
      i.clear(),
      i.renderBufferDirect(C, null, z, f, M, null),
      ...
      i.clear(),
      i.renderBufferDirect(C, null, z, m, M, null));
  }
  function E(y, C, z, S) {
    let v = null;
    const P =
    ...
    if (P !== void 0) v = P;
      ...
      let W = q[G];
      (W === void 0 &&
        ((W = v.clone()), (q[G] = W), C.addEventListener("dispose", D)),
        (v = W));
    }
    if (
      ((v.visible = C.visible),
    ...
    if (
      ...
      if (Array.isArray(q)) {
        ...
        for (let K = 0, J = W.length; K < J; K++) {
          const H = W[K],
            ne = q[H.materialIndex];
          if (ne && ne.visible) {
            const se = E(y, ne, S, v);
            (y.onBeforeShadow(i, y, C, z, G, se, H),
              i.renderBufferDirect(z, null, G, se, y, H),
              y.onAfterShadow(i, y, C, z, G, se, H));
          }
        }
      } else if (q.visible) {
        const W = E(y, q, S, v);
        (y.onBeforeShadow(i, y, C, z, G, W, null),
          i.renderBufferDirect(z, null, G, W, y, null),
          y.onAfterShadow(i, y, C, z, G, W, null));
      }
    }
    const B = y.children;
    for (let G = 0, q = B.length; G < q; G++) w(B[G], C, z, S, v);
  }
  function D(y) {
...
function zf(i, e) {
  function t() {
    ...
    return {
      ...
      setClear: function (Q, Y, fe, Ce, tt) {
        (tt === !0 && ((Q *= Ce), (Y *= Ce), (fe *= Ce)),
          ce.set(Q, Y, fe, Ce),
          re.equals(ce) === !1 && (i.clearColor(Q, Y, fe, Ce), re.copy(ce)));
      },
      reset: function () {
        ((R = !1), (ie = null), re.set(-1, 0, 0, 0));
      },
    };
  }
  function n() {
    ...
    return {
      ...
      setClear: function (Y) {
        Q !== Y && (ce && (Y = 1 - Y), i.clearDepth(Y), (Q = Y));
      },
      reset: function () {
        ((R = !1), (ie = null), (re = null), (Q = null), (ce = !1));
      },
    };
  }
  function r() {
    ...
    return {
      ...
      setFunc: function (Ye, Wt, Bt) {
        (ie !== Ye || re !== Wt || Q !== Bt) &&
          (i.stencilFunc(Ye, Wt, Bt), (ie = Ye), (re = Wt), (Q = Bt));
      },
      setOp: function (Ye, Wt, Bt) {
        (Y !== Ye || fe !== Wt || Ce !== Bt) &&
          (i.stencilOp(Ye, Wt, Bt), (Y = Ye), (fe = Wt), (Ce = Bt));
      },
  ...
  H.indexOf("WebGL") !== -1
    ? ((J = parseFloat(/^WebGL (\d)/.exec(H)[1])), (K = J >= 1))
    : H.indexOf("OpenGL ES") !== -1 &&
      ((J = parseFloat(/^OpenGL ES (\d)/.exec(H)[1])), (K = J >= 2));
  let ne = null,
    se = {};
  ...
  function Qe(R, ce, ie, re) {
    ...
    for (let fe = 0; fe < ie; fe++)
      R === i.TEXTURE_3D || R === i.TEXTURE_2D_ARRAY
        ? i.texImage3D(ce, 0, i.RGBA, 1, 1, re, 0, i.RGBA, i.UNSIGNED_BYTE, Q)
        : i.texImage2D(ce + fe, 0, i.RGBA, 1, 1, 0, i.RGBA, i.UNSIGNED_BYTE, Q);
    return Y;
  }
  const X = {};
  ...
  function Le(R, ce) {
    return d[R] !== ce
      ? (i.bindFramebuffer(R, ce),
        (d[R] = ce),
        R === i.DRAW_FRAMEBUFFER && (d[i.FRAMEBUFFER] = ce),
        R === i.FRAMEBUFFER && (d[i.DRAW_FRAMEBUFFER] = ce),
        !0)
      : !1;
  }
  function ge(R, ce) {
  ...
  const Fe = {
    ...
    [$o]: i.ONE_MINUS_DST_ALPHA,
    [tc]: i.CONSTANT_COLOR,
    [nc]: i.ONE_MINUS_CONSTANT_COLOR,
    [ic]: i.CONSTANT_ALPHA,
    [rc]: i.ONE_MINUS_CONSTANT_ALPHA,
  };
  function nt(R, ce, ie, re, Q, Y, fe, Ce, tt, Ye) {
    if (R === sn) {
      M === !0 && (de(i.BLEND), (M = !1));
      return;
    }
    if ((M === !1 && (j(i.BLEND), (M = !0)), R !== Go)) {
      if (R !== p || Ye !== S) {
        if (
          ((h !== Dn || w !== Dn) &&
            (i.blendEquation(i.FUNC_ADD), (h = Dn), (w = Dn)),
          Ye)
        )
          switch (R) {
            case ni:
            ...
            case ia:
              ...
              break;
            default:
              ct("WebGLState: Invalid blending: ", R);
              break;
          }
        else
          switch (R) {
    ...
    ((Q = Q || ce),
      ...
      (fe = fe || re),
      (ce !== h || Q !== w) &&
        (i.blendEquationSeparate(xt[ce], xt[Q]), (h = ce), (w = Q)),
      (ie !== T || re !== E || Y !== D || fe !== y) &&
        ...
        (y = fe)),
      (Ce.equals(C) === !1 || tt !== z) &&
        (i.blendColor(Ce.r, Ce.g, Ce.b, tt), C.copy(Ce), (z = tt)),
      (p = R),
      (S = !1));
  }
  function A(R, ce) {
    R.side === tn ? de(i.CULL_FACE) : j(i.CULL_FACE);
    let ie = R.side === At;
    (ce && (ie = !ie),
      ze(ie),
    ...
    (o.setTest(re),
      ...
      me(R.polygonOffset, R.polygonOffsetFactor, R.polygonOffsetUnits),
      R.alphaToCoverage === !0
        ? j(i.SAMPLE_ALPHA_TO_COVERAGE)
        : de(i.SAMPLE_ALPHA_TO_COVERAGE));
  }
  function ze(R) {
    v !== R && (R ? i.frontFace(i.CW) : i.frontFace(i.CCW), (v = R));
  }
  function Ve(R) {
    (R !== Bo
      ? (j(i.CULL_FACE),
  ...
  function et(R) {
    R !== B && (K && i.lineWidth(R), (B = R));
  }
  function me(R, ce, ie) {
    R
      ? (j(i.POLYGON_OFFSET_FILL),
        (G !== ce || q !== ie) && (i.polygonOffset(ce, ie), (G = ce), (q = ie)))
  ...
  function Me(R) {
    (R === void 0 && (R = i.TEXTURE0 + W - 1),
      ne !== R && (i.activeTexture(R), (ne = R)));
  }
  function Pe(R, ce, ie) {
    ie === void 0 && (ne === null ? (ie = i.TEXTURE0 + W - 1) : (ie = ne));
    let re = se[ie];
    (re === void 0 && ((re = { type: void 0, texture: void 0 }), (se[ie] = re)),
      (re.type !== R || re.texture !== ce) &&
        (ne !== ie && (i.activeTexture(ie), (ne = ie)),
        i.bindTexture(R, ce || X[R]),
        (re.type = R),
        (re.texture = ce)));
  }
  function b() {
  ...
  function ye(R, ce) {
    ...
    let re = ie.get(R);
    re === void 0 && ((re = i.getUniformBlockIndex(ce, R.name)), ie.set(R, re));
  }
  function he(R, ce) {
    const re = c.get(ce).get(R);
    l.get(ce) !== re &&
      (i.uniformBlockBinding(ce, re, R.__bindingPointIndex), l.set(ce, re));
  }
  function we() {
    (i.disable(i.BLEND),
...
function Vf(i, e, t, n, r, s, a) {
  ...
  function g(b, x) {
    return m ? new OffscreenCanvas(b, x) : ar("canvas");
  }
  function M(b, x, I) {
    let k = 1;
    const Z = Pe(b);
    if (
      ((Z.width > I || Z.height > I) && (k = I / Math.max(Z.width, Z.height)),
      k < 1)
    )
      if (
        ...
        const V = Math.floor(k * Z.width),
          _e = Math.floor(k * Z.height);
        d === void 0 && (d = g(V, _e));
        const oe = x ? g(V, _e) : d;
        return (
          (oe.width = V),
  ...
  function E(b, x, I, k, Z = !1) {
    ...
    if (
      ...
      const _e = Z ? rr : We.getTransfer(k);
  ...
  function z(b) {
    ...
    if (k) {
      ...
      (Z.usedTimes--,
        Z.usedTimes === 0 && S(b),
        Object.keys(k).length === 0 && f.delete(I));
    }
    n.remove(b);
  }
  function S(b) {
      ...
      for (let k = 0; k < 6; k++) {
        if (Array.isArray(x.__webglFramebuffer[k]))
          for (let Z = 0; Z < x.__webglFramebuffer[k].length; Z++)
            i.deleteFramebuffer(x.__webglFramebuffer[k][Z]);
        else i.deleteFramebuffer(x.__webglFramebuffer[k]);
      ...
      if (
        ...
        for (let k = 0; k < x.__webglColorRenderbuffer.length; k++)
          x.__webglColorRenderbuffer[k] &&
            i.deleteRenderbuffer(x.__webglColorRenderbuffer[k]);
  ...
  const ne = { [ns]: i.REPEAT, [nn]: i.CLAMP_TO_EDGE, [is]: i.MIRRORED_REPEAT },
    se = {
      [Dt]: i.NEAREST,
  ...
  function He(b, x) {
    if (
      ...
      i.texParameteri(b, i.TEXTURE_WRAP_S, ne[x.wrapS]),
      i.texParameteri(b, i.TEXTURE_WRAP_T, ne[x.wrapT]),
      (b === i.TEXTURE_3D || b === i.TEXTURE_2D_ARRAY) &&
        i.texParameteri(b, i.TEXTURE_WRAP_R, ne[x.wrapR]),
      ...
      if (
        ...
        (x.type === rn && e.has("OES_texture_float_linear") === !1)
      )
        return;
  ...
  function Qe(b, x, I, k) {
    ...
    if (V.length === 0)
      t.texSubImage2D(i.TEXTURE_2D, 0, 0, 0, x.width, x.height, I, k, x.data);
    else {
      ...
      for (let $ = 1; $ < V.length; $++) {
        const te = V[_e],
          Ae = V[$],
          ye = te.start + te.count,
          he = Je(Ae.start, x.width, 4),
          we = Je(te.start, x.width, 4);
        Ae.start <= ye + 1 &&
        he === we &&
        Je(Ae.start + Ae.count - 1, x.width, 4) === he
          ? (te.count = Math.max(te.count, Ae.start + Ae.count - te.start))
          : (++_e, (V[_e] = Ae));
      }
      V.length = _e + 1;
      ...
      for (let $ = 0, te = V.length; $ < te; $++) {
        const Ae = V[$],
          ...
          we = ye % x.width,
          R = Math.floor(ye / x.width),
          ce = he,
          ie = 1;
        (i.pixelStorei(i.UNPACK_SKIP_PIXELS, we),
          i.pixelStorei(i.UNPACK_SKIP_ROWS, R),
          t.texSubImage2D(i.TEXTURE_2D, 0, we, R, ce, ie, I, k, x.data));
      }
      (b.clearUpdateRanges(),
  ...
  function X(b, x, I) {
    ...
    ((x.isDataArrayTexture || x.isCompressedArrayTexture) &&
      ...
      x.isData3DTexture && (k = i.TEXTURE_3D));
    const Z = Xe(b, x),
      V = x.source;
    t.bindTexture(k, b.__webglTexture, i.TEXTURE0 + I);
    const _e = n.get(V);
    if (V.version !== _e.__version || Z === !0) {
      t.activeTexture(i.TEXTURE0 + I);
      const oe = We.getPrimaries(We.workingColorSpace),
        be = x.colorSpace === gn ? null : We.getPrimaries(x.colorSpace),
        xe =
          x.colorSpace === gn || oe === be ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      ...
      if (x.isDepthTexture)
        ...
        if (x.isCompressedArrayTexture) {
          ...
          for (let Q = 0, Y = we.length; Q < Y; Q++)
            if (((he = we[Q]), x.format !== kt))
              if (te !== null)
                if (R) {
                  if (ie)
                    if (x.layerUpdates.size > 0) {
                      const fe = Aa(he.width, he.height, x.format, x.type);
        ...
        if (R) {
          if (
            ...
            if (x.layerUpdates.size > 0) {
              const Q = Aa($.width, $.height, x.format, x.type);
        ...
        if (ce)
          if (R) t.texStorage2D(i.TEXTURE_2D, re, ye, $.width, $.height);
          else {
            let Q = $.width,
              Y = $.height;
            for (let fe = 0; fe < re; fe++)
              (t.texImage2D(i.TEXTURE_2D, fe, ye, Q, Y, 0, te, Ae, null),
                (Q >>= 1),
                (Y >>= 1));
          }
      } else if (we.length > 0) {
        if (R && ce) {
          const Q = Pe(we[0]);
          t.texStorage2D(i.TEXTURE_2D, re, ye, Q.width, Q.height);
        }
        for (let Q = 0, Y = we.length; Q < Y; Q++)
          ((he = we[Q]),
            R
              ? ie && t.texSubImage2D(i.TEXTURE_2D, Q, 0, 0, te, Ae, he)
              : t.texImage2D(i.TEXTURE_2D, Q, ye, te, Ae, he));
        x.generateMipmaps = !1;
      } else if (R) {
        if (ce) {
          const Q = Pe($);
      ...
      (p(x) && h(k), (_e.__version = V.version), x.onUpdate && x.onUpdate(x));
    }
  ...
  function j(b, x, I) {
    ...
    if (Z.version !== V.__version || k === !0) {
      ...
      const _e = We.getPrimaries(We.workingColorSpace),
        oe = x.colorSpace === gn ? null : We.getPrimaries(x.colorSpace),
        be =
          x.colorSpace === gn || _e === oe ? i.NONE : i.BROWSER_DEFAULT_WEBGL;
      (i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL, x.flipY),
        i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL, x.premultiplyAlpha),
        i.pixelStorei(i.UNPACK_ALIGNMENT, x.unpackAlignment),
      ...
      for (let Y = 0; Y < 6; Y++)
        (!xe && !$
          ? (te[Y] = M(x.image[Y], !0, r.maxCubemapSize))
          : (te[Y] = $ ? x.image[Y].image : x.image[Y]),
          (te[Y] = Me(x, te[Y])));
      const Ae = te[0],
        ye = s.convert(x.format, x.colorSpace),
        he = s.convert(x.type),
        we = E(x.internalFormat, ye, he, x.colorSpace),
        R = x.isVideoTexture !== !0,
        ce = V.__version === void 0 || k === !0,
        ie = Z.dataReady;
      let re = D(x, Ae);
  ...
  function de(b, x, I, k, Z, V) {
    ...
    if ((($.__renderTarget = x), !xe.__hasExternalTextures)) {
      const te = Math.max(1, x.width >> V),
        Ae = Math.max(1, x.height >> V);
      Z === i.TEXTURE_3D || Z === i.TEXTURE_2D_ARRAY
        ? t.texImage3D(Z, V, be, te, Ae, x.depth, 0, _e, oe, null)
        : t.texImage2D(Z, V, be, te, Ae, 0, _e, oe, null);
    }
    (t.bindFramebuffer(i.FRAMEBUFFER, b),
      me(x)
        ...
        : (Z === i.TEXTURE_2D ||
          ...
          i.framebufferTexture2D(i.FRAMEBUFFER, k, Z, $.__webglTexture, V),
  ...
  function ge(b, x) {
    ...
    else if (x.depthTexture.format === Ei)
      me(x)
        ? o.framebufferTexture2DMultisampleEXT(
            i.FRAMEBUFFER,
  ...
  function Be(b) {
    ...
    if (b.depthTexture && !x.__autoAllocateDepthBuffer) {
      ...
      for (let k = 0; k < 6; k++)
        if (
          (t.bindFramebuffer(i.FRAMEBUFFER, x.__webglFramebuffer[k]),
          x.__webglDepthbuffer[k] === void 0)
        )
          ((x.__webglDepthbuffer[k] = i.createRenderbuffer()),
            Le(x.__webglDepthbuffer[k], b, !1));
        else {
          const Z = b.stencilBuffer
              ? i.DEPTH_STENCIL_ATTACHMENT
              : i.DEPTH_ATTACHMENT,
            V = x.__webglDepthbuffer[k];
    ...
    if (V) {
      ...
      for (let oe = 0, be = Z.length; oe < be; oe++) {
        ...
        ((b.isWebGL3DRenderTarget || b.isWebGLArrayRenderTarget) &&
          (te = b.isWebGL3DRenderTarget ? i.TEXTURE_3D : i.TEXTURE_2D_ARRAY),
          t.bindTexture(te, $.__webglTexture),
          He(te, xe),
          de(I.__webglFramebuffer, b, xe, i.COLOR_ATTACHMENT0 + oe, te, 0),
          p(xe) && h(te));
      }
      t.unbindTexture();
    } else {
      ...
      if (
        ...
        t.bindTexture(oe, k.__webglTexture),
        He(oe, x),
    ...
    if (b.samples > 0) {
      if (me(b) === !1) {
        ...
        for (let xe = 0; xe < x.length; xe++) {
          ...
          (i.blitFramebuffer(0, 0, I, k, 0, 0, I, k, Z, i.NEAREST),
            l === !0 &&
              ((A.length = 0),
              (ze.length = 0),
...
function Gf(i, e) {
  function t(n, r = gn) {
    ...
    if (n === bi) return i.DEPTH_COMPONENT;
    ...
    if (n === $i || n === Ji || n === Qi || n === er)
      if (a === Ke)
        if (((s = e.get("WEBGL_compressed_texture_s3tc_srgb")), s !== null)) {
          if (n === $i) return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;
    ...
    if (n === Ts || n === As || n === Rs)
      if (((s = e.get("EXT_texture_compression_bptc")), s !== null)) {
        ...
        if (n === Rs) return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT;
      } else return null;
    if (n === ws || n === Cs || n === Ps || n === Ds)
...
class Wf {
  ...
  getMesh(e) {
    if (this.texture !== null && this.mesh === null) {
      ...
      this.mesh = new ln(new lr(20, 20), n);
    }
    return this.mesh;
  }
  reset() {
  ...
  constructor(e, t) {
    ...
    ((this.cameraAutoUpdate = !0),
      ...
      (this.getController = function (X) {
        let j = D[X];
        return (
          j === void 0 && ((j = new Or()), (D[X] = j)),
          j.getTargetRaySpace()
        );
      }),
      (this.getControllerGrip = function (X) {
        let j = D[X];
        return (j === void 0 && ((j = new Or()), (D[X] = j)), j.getGripSpace());
      }),
      (this.getHand = function (X) {
        let j = D[X];
        return (j === void 0 && ((j = new Or()), (D[X] = j)), j.getHandSpace());
      }));
    function W(X) {
        ...
        if (((r = X), r !== null)) {
          if (
            ...
            ((d = this.getBinding()),
              ...
              (w = new On(f.textureWidth, f.textureHeight, {
                format: kt,
                type: on,
                depthTexture: new So(
                  f.textureWidth,
            ...
            ((m = new XRWebGLLayer(r, t, de)),
              ...
              (w = new On(m.framebufferWidth, m.framebufferHeight, {
                format: kt,
                type: on,
                colorSpace: e.outputColorSpace,
                stencilBuffer: T.stencil,
    ...
    function se(X, j, de) {
      (H.setFromMatrixPosition(j.matrixWorld),
        ne.setFromMatrixPosition(de.matrixWorld));
      const Le = H.distanceTo(ne),
      ...
      if (
        ...
        const Pe = xt + it,
          ...
          k = ((nt * Fe) / b) * Pe,
          Z = ((A * Fe) / b) * Pe;
        (X.projectionMatrix.makePerspective(x, I, k, Z, Pe, b),
    ...
    function Je(X, j) {
      if (((u = j.getViewerPose(c || a)), (g = j), u !== null)) {
        const de = u.views;
        m !== null &&
          (e.setRenderTargetFramebuffer(w, m.framebuffer),
          e.setRenderTarget(w));
        let Le = !1;
...
function qf(i, e) {
  ...
  function n(p, h) {
    (h.color.getRGB(p.fogColor.value, _o(i)),
      h.isFog
      ...
      : h.isMeshToonMaterial
        ...
        : h.isMeshPhongMaterial
          ...
          : h.isMeshStandardMaterial
            ? (s(p, h), f(p, h), h.isMeshPhysicalMaterial && m(p, h, w))
  ...
  function s(p, h) {
    ...
    (E &&
      ...
      E.isCubeTexture &&
        ...
        ((Pn.y *= -1), (Pn.z *= -1)),
      p.envMapRotation.value.setFromMatrix4(Yf.makeRotationFromEuler(Pn)),
      (p.flipEnvMap.value =
...
function Kf(i, e, t, n) {
  ...
  function c(T, E) {
    let w = r[T.id];
    w === void 0 &&
      (g(T), (w = u(T)), (r[T.id] = w), T.addEventListener("dispose", p));
    const D = E.program;
  ...
  function u(T) {
    ...
    return (
      ...
      i.bindBufferBase(i.UNIFORM_BUFFER, E, w),
      w
    );
  }
  function d() {
  ...
  function f(T) {
    ...
    for (let y = 0, C = w.length; y < C; y++) {
      const z = Array.isArray(w[y]) ? w[y] : [w[y]];
        ...
        if (m(P, y, S, D) === !0) {
          ...
          for (let W = 0; W < G.length; W++) {
            ...
            typeof K == "number" || typeof K == "boolean"
              ? ((P.__data[0] = K),
                i.bufferSubData(i.UNIFORM_BUFFER, B + q, P.__data))
              : K.isMatrix3
                ? ((P.__data[0] = K.elements[0]),
                  ...
                  (P.__data[11] = 0))
                : (K.toArray(P.__data, q),
                  (q += J.storage / Float32Array.BYTES_PER_ELEMENT));
          }
  ...
  function p(T) {
    ...
    (a.splice(w, 1), i.deleteBuffer(r[E.id]), delete r[E.id], delete s[E.id]);
  }
  function h() {
...
class $f {
  constructor(e = {}) {
    ...
    const g = new Set([Gs, Vs, Bs]),
      M = new Set([on, Nn, Mi, Si, Fs, Os]),
      p = new Uint32Array(4),
      h = new Int32Array(4);
    let T = null,
      E = null;
    ...
    try {
      ...
      if (
        ("setAttribute" in t &&
          t.setAttribute("data-engine", `three.js r${Is}`),
    ...
    function ie() {
      ((Ve = new rd(A)),
        ...
        (Ae = new cd(A, et, Pe)),
        (xe = new ju(Me)),
        (V = new Tf(y, b, x, Ve, et, R, xe)),
        (_e = new qf(y, Me)),
        (oe = new wf()),
        (be = new If(Ve)),
        (te = new Yu(y, b, x, me, Z, m, l)),
        ($ = new Of(y, Z, et)),
        (ce = new Kf(A, it, et, me)),
        (ye = new Ku(A, Ve, it)),
        (he = new ad(A, Ve, it)),
    ...
    ((this.xr = re),
      ...
      (this.setPixelRatio = function (_) {
        _ !== void 0 && ((se = _), this.setSize(H, ne, !1));
      }),
      ...
      (this.setScissor = function (_, L, N, O) {
        (_.isVector4 ? Je.set(_.x, _.y, _.z, _.w) : Je.set(_, L, N, O),
          me.scissor(q.copy(Je).multiplyScalar(se).round()));
      }),
      ...
      (this.getClearColor = function (_) {
        return _.copy(te.getClearColor());
      }),
      ...
      (this.clear = function (_ = !0, L = !0, N = !0) {
        ...
        if (_) {
          let U = !1;
          if (v !== null) {
            const ee = v.texture.format;
            U = g.has(ee);
          }
          if (U) {
            const ee = v.texture.type,
              le = M.has(ee),
              pe = te.getClearColor(),
              ue = te.getClearAlpha(),
              Te = pe.r,
      ...
      (this.dispose = function () {
        (t.removeEventListener("webglcontextlost", Q, !1),
          ...
          V.dispose(),
          re.dispose(),
          re.removeEventListener("sessionstart", qs),
          re.removeEventListener("sessionend", Ks),
          En.stop());
      }));
    function Q(_) {
      (_.preventDefault(), ca("WebGLRenderer: Context Lost."), (C = !0));
    }
    function Y() {
      (ca("WebGLRenderer: Context Restored."), (C = !1));
    ...
    this.renderBufferDirect = function (_, L, N, O, U, ee) {
      L === null && (L = xt);
      ...
      let ue = N.index,
        Te = 1;
      if (O.wireframe === !0) {
        if (((ue = k.getWireframeAttribute(N)), ue === void 0)) return;
        Te = 2;
      }
      const Re = N.drawRange,
        ve = N.attributes.position;
      let Ge = Re.start * Te,
        qe = (Re.start + Re.count) * Te;
      (ee !== null &&
        ((Ge = Math.max(Ge, ee.start * Te)),
        (qe = Math.min(qe, (ee.start + ee.count) * Te))),
        ue !== null
      ...
      if (U.isBatchedMesh)
        if (U._multiDrawInstances !== null)
          ...
          const Ee = U._multiDrawStarts,
            ...
            zn = Me.get(O).currentProgram.getUniforms();
          for (let wt = 0; wt < ke; wt++)
            (zn.setValue(A, "_gl_DrawID", wt), $e.render(Ee[wt] / Rt, rt[wt]));
        }
    ...
    function Wt(_, L, N) {
      _.transparent === !0 && _.side === tn && _.forceSinglePass === !1
        ? ((_.side = At),
          (_.needsUpdate = !0),
          wi(_, L, N),
          (_.side = Sn),
    ...
    const En = new Eo();
    (En.setAnimationLoop(Do),
      typeof self < "u" && En.setContext(self),
      (this.setAnimationLoop = function (_) {
        ((Bt = _), re.setAnimationLoop(_), _ === null ? En.stop() : En.start());
      }),
      re.addEventListener("sessionstart", qs),
      ...
      (this.render = function (_, L) {
        ...
        if (
          ...
          X.setFromProjectionMatrix(Le, Yt, L.reversedDepth),
          ...
          ee !== null && fr(ee, L, -1 / 0, y.sortObjects);
        }
        (fr(_, L, 0, y.sortObjects),
          T.finish(),
          y.sortObjects === !0 && T.sort(Se, He),
          (Fe =
            re.enabled === !1 ||
            re.isPresenting === !1 ||
            re.hasDepthSensing() === !1),
          Fe && te.addToRenderList(T, _),
        ...
        if ((E.setupLights(), L.isArrayCamera)) {
          ...
          for (let le = 0, pe = ee.length; le < pe; le++) {
            const ue = ee[le];
            Zs(T, _, ue, ue.viewport);
          }
        } else
          (U.length > 0 && js(O, U, _, L), Fe && te.render(_), Zs(T, _, L));
        (v !== null &&
          S === 0 &&
    ...
    function fr(_, L, N, O) {
      ...
      const ee = _.children;
      for (let le = 0, pe = ee.length; le < pe; le++) fr(ee[le], L, N, O);
    }
    function Zs(_, L, N, O) {
      const { opaque: U, transmissive: ee, transparent: le } = _;
      (E.setupLightsView(N),
        j === !0 && xe.setGlobalState(y.clippingPlanes, N),
        O && me.viewport(G.copy(O)),
        U.length > 0 && Ri(U, L, N),
        ee.length > 0 && Ri(ee, L, N),
        le.length > 0 && Ri(le, L, N),
    ...
    function js(_, L, N, O) {
      ...
      E.state.transmissionRenderTarget[O.id] === void 0 &&
        (E.state.transmissionRenderTarget[O.id] = new On(1, 1, {
          generateMipmaps: !0,
          type:
      ...
      const ee = E.state.transmissionRenderTarget[O.id],
        le = O.viewport || G;
      ee.setSize(
      ...
      if (
        ...
        Ri(_, N, O),
        Pe.updateMultisampleRenderTarget(ee),
        Pe.updateRenderTargetMipmap(ee),
        ...
        for (let qe = 0, at = L.length; qe < at; qe++) {
          ...
          if (rt.side === tn && $e.layers.test(O.layers)) {
            const Rt = rt.side;
            ((rt.side = At),
              (rt.needsUpdate = !0),
              $s($e, N, O, Ee, rt, ke),
    ...
    function Ri(_, L, N) {
      ...
      for (let U = 0, ee = _.length; U < ee; U++) {
        const le = _[U],
          { object: pe, geometry: ue, group: Te } = le;
        let Re = le.material;
        (Re.allowOverride === !0 && O !== null && (Re = O),
          pe.layers.test(N.layers) && $s(pe, L, N, ue, Re, Te));
      }
    }
    function $s(_, L, N, O, U, ee) {
      (_.onBeforeRender(y, L, N, O, U, ee),
        _.modelViewMatrix.multiplyMatrices(N.matrixWorldInverse, _.matrixWorld),
        _.normalMatrix.getNormalMatrix(_.modelViewMatrix),
        U.onBeforeRender(y, L, N, O, _, ee),
        U.transparent === !0 && U.side === tn && U.forceSinglePass === !1
          ? ((U.side = At),
            (U.needsUpdate = !0),
            y.renderBufferDirect(N, L, O, U, _, ee),
            (U.side = Sn),
            (U.needsUpdate = !0),
            y.renderBufferDirect(N, L, O, U, _, ee),
            (U.side = tn))
          : y.renderBufferDirect(N, L, O, U, _, ee),
        _.onAfterRender(y, L, N, O, U, ee));
    }
    function wi(_, L, N) {
      L.isScene !== !0 && (L = xt);
      const O = Me.get(_),
        U = E.state.lights,
        ee = E.state.shadowsArray,
        le = U.state.version,
        pe = V.getParameters(_, U.state, ee, L, N),
      ...
      let Re = Te.get(ue);
      if (Re !== void 0) {
        if (O.currentProgram === Re && O.lightsStateVersion === le)
          return (Qs(_, pe), Re);
      } else
        ((pe.uniforms = V.getUniforms(_)),
          _.onBeforeCompile(pe, y),
          (Re = V.acquireProgram(pe, ue)),
          Te.set(ue, Re),
    ...
    function Js(_) {
      if (_.uniformsList === null) {
        ...
        _.uniformsList = nr.seqWithValue(L.seq, _.uniforms);
      }
    ...
    function Lo(_, L, N, O, U) {
      ...
      const ee = L.fog,
        ...
        Re = !!N.attributes.tangent && (!!O.normalMap || O.anisotropy > 0),
      ...
      const st = Rt.getUniforms(),
        bt = Ee.uniforms;
      if (
        (me.useProgram(Rt.program) && ((zn = !0), (wt = !0), (di = !0)),
        O.id !== P && ((P = O.id), (wt = !0)),
        zn || B !== _)
      ) {
      ...
      if (
        ...
        bt.dfgLUT !== void 0 && (bt.dfgLUT.value = jf()),
        wt &&
          (st.setValue(A, "toneMappingExposure", y.toneMappingExposure),
          Ee.needsLights && Uo(bt, di),
          ee && O.fog === !0 && _e.refreshFogUniforms(bt, ee),
          ...
          nr.upload(A, Js(Ee), bt, Pe)),
        O.isShaderMaterial &&
          O.uniformsNeedUpdate === !0 &&
          (nr.upload(A, Js(Ee), bt, Pe), (O.uniformsNeedUpdate = !1)),
        ...
        for (let Et = 0, pr = vt.length; Et < pr; Et++) {
          const yn = vt[Et];
          (ce.update(yn, Rt), ce.bind(yn, Rt));
        }
      }
      return Rt;
    }
    ...
    ((this.setRenderTarget = function (_, L = 0, N = 0) {
      ...
      if (_) {
        ...
        (_.isWebGLCubeRenderTarget
          ? (Array.isArray(Re[L]) ? (U = Re[L][N]) : (U = Re[L]), (ee = !0))
        ...
        (G.copy(Xe).multiplyScalar(se).floor(),
          q.copy(Je).multiplyScalar(se).floor(),
          (W = Qe));
      if (
        (N !== 0 && (U = No),
      ...
      (this.readRenderTargetPixels = function (_, L, N, O, U, ee, le, pe = 0) {
        ...
        if ((_.isWebGLCubeRenderTarget && le !== void 0 && (ue = ue[le]), ue)) {
          ...
          try {
            ...
            L >= 0 &&
              ...
              A.readPixels(L, N, O, U, we.convert(Re), we.convert(ve), ee));
          } finally {
        ...
        if ((_.isWebGLCubeRenderTarget && le !== void 0 && (ue = ue[le]), ue))
          if (L >= 0 && L <= _.width - O && N >= 0 && N <= _.height - U) {
            ...
            (A.bindBuffer(A.PIXEL_PACK_BUFFER, Ge),
              A.bufferData(A.PIXEL_PACK_BUFFER, ee.byteLength, A.STREAM_READ),
              _.textures.length > 1 && A.readBuffer(A.COLOR_ATTACHMENT0 + pe),
              A.readPixels(L, N, O, U, we.convert(Re), we.convert(ve), 0));
            ...
            return (
              ...
              await Rc(A, at, 4),
              A.bindBuffer(A.PIXEL_PACK_BUFFER, Ge),
              A.getBufferSubData(A.PIXEL_PACK_BUFFER, 0, ee),
              A.deleteBuffer(Ge),
              A.deleteSync(at),
              ee
            );
      ...
      (this.copyFramebufferToTexture = function (_, L = null, N = 0) {
        const O = Math.pow(2, -N),
          ...
          ee = Math.floor(_.image.height * O),
          le = L !== null ? L.x : 0,
          pe = L !== null ? L.y : 0;
        (Pe.setTexture2D(_, 0),
          A.copyTexSubImage2D(A.TEXTURE_2D, N, 0, 0, le, pe, U, ee),
          me.unbindTexture());
      }));
    const Fo = A.createFramebuffer(),
      Oo = A.createFramebuffer();
    ((this.copyTextureToTexture = function (
      ...
      ee === null &&
        (U !== 0
          ? (yi(
            ...
            (U = 0))
          : (ee = 0));
      let le, pe, ue, Te, Re, ve, Ge, qe, at;
      const ot = _.isCompressedTexture ? _.mipmaps[ee] : _.image;
      if (N !== null)
        ((le = N.max.x - N.min.x),
          (pe = N.max.y - N.min.y),
      ...
      const ke = A.getParameter(A.UNPACK_ROW_LENGTH),
        ...
        zn = A.getParameter(A.UNPACK_SKIP_PIXELS),
        wt = A.getParameter(A.UNPACK_SKIP_ROWS),
        di = A.getParameter(A.UNPACK_SKIP_IMAGES);
      (A.pixelStorei(A.UNPACK_ROW_LENGTH, ot.width),
        ...
        A.pixelStorei(A.UNPACK_SKIP_ROWS, Re),
      ...
      if (_.isDepthTexture) {
        ...
        const Ut = Me.get(_),
          vt = Me.get(L);
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, Fo),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, Oo));
        for (let Et = 0; Et < ue; Et++)
          (st
            ...
            U !== 0
              ...
              : bt
                ? A.copyTexSubImage3D(rt, ee, Ge, qe, at + Et, Te, Re, le, pe)
                : A.copyTexSubImage2D(rt, ee, Ge, qe, Te, Re, le, pe));
        (me.bindFramebuffer(A.READ_FRAMEBUFFER, null),
          me.bindFramebuffer(A.DRAW_FRAMEBUFFER, null));
      } else
        bt
          ? _.isDataTexture || _.isData3DTexture
            ? A.texSubImage3D(rt, ee, Ge, qe, at, le, pe, ue, $e, Ee, ot.data)
            : L.isCompressedArrayTexture
              ...
              : A.texSubImage3D(rt, ee, Ge, qe, at, le, pe, ue, $e, Ee, ot)
          : _.isDataTexture
            ? A.texSubImage2D(A.TEXTURE_2D, ee, Ge, qe, le, pe, $e, Ee, ot.data)
            : _.isCompressedTexture
              ...
              : A.texSubImage2D(A.TEXTURE_2D, ee, Ge, qe, le, pe, $e, Ee, ot);
      (A.pixelStorei(A.UNPACK_ROW_LENGTH, ke),
        A.pixelStorei(A.UNPACK_IMAGE_HEIGHT, Rt),
        A.pixelStorei(A.UNPACK_SKIP_PIXELS, zn),
        A.pixelStorei(A.UNPACK_SKIP_ROWS, wt),
        A.pixelStorei(A.UNPACK_SKIP_IMAGES, di),
        ee === 0 && L.generateMipmaps && A.generateMipmap(rt),
        me.unbindTexture());
    }),
      ...
      (this.resetState = function () {
        ((z = 0), (S = 0), (v = null), me.reset(), R.reset());
      }),
      typeof __THREE_DEVTOOLS__ < "u" &&
        __THREE_DEVTOOLS__.dispatchEvent(
          new CustomEvent("observe", { detail: this }),
...
class Qf extends ll {
  constructor(e, t = null) {
    (super(e, t),
      ...
      (this._quat = new Fn().setFromUnitVectors(e.up, new F(0, 1, 0))),
      (this._quatInverse = this._quat.clone().invert()),
      (this._spherical = new Ta()),
      (this._sphericalDelta = new Ta()),
      (this._scale = 1),
      ...
      (this._onPointerMove = tp.bind(this)),
      (this._onPointerDown = ep.bind(this)),
      (this._onPointerUp = np.bind(this)),
      (this._onContextMenu = lp.bind(this)),
      (this._onMouseWheel = sp.bind(this)),
      (this._onKeyDown = ap.bind(this)),
      (this._onTouchStart = op.bind(this)),
      (this._onTouchMove = cp.bind(this)),
      (this._onMouseDown = ip.bind(this)),
      (this._onMouseMove = rp.bind(this)),
      (this._interceptControlDown = hp.bind(this)),
      (this._interceptControlUp = up.bind(this)),
  ...
  update(e = null) {
    ...
    if (
      ...
      a !== null &&
        (this.screenSpacePanning
          ...
          : (ji.origin.copy(this.object.position),
            ji.direction.set(0, 0, -1).transformDirection(this.object.matrix),
            Math.abs(this.object.up.dot(ji.direction)) < Jf
              ? this.object.lookAt(this.target)
              : ($a.setFromNormalAndCoplanarPoint(this.object.up, this.target),
                ji.intersectPlane($a, this.target))));
    } else if (this.object.isOrthographicCamera) {
    ...
    return (
      ...
      (this._performCursorZoom = !1),
      s ||
      this._lastPosition.distanceToSquared(this.object.position) > Wr ||
      8 * (1 - this._lastQuaternion.dot(this.object.quaternion)) > Wr ||
      this._lastTargetPosition.distanceToSquared(this.target) > Wr
        ? (this.dispatchEvent(ja),
...
function ip(i) {
  ...
  this.state !== Ze.NONE && this.dispatchEvent(Xs);
}
function rp(i) {
  switch (this.state) {
    case Ze.ROTATE:
...
const Co = new el(),
  Ys = new Ft(75, window.innerWidth / window.innerHeight, 0.1, 1e3),
  dr = new $f();
dr.setSize(window.innerWidth, window.innerHeight);
document.body.appendChild(dr.domElement);
Ys.position.z = 3;
const dp = new hi(),
  fp = new Ws({ color: 65280 }),
  ir = new ln(dp, fp);
Co.add(ir);
const pp = new Qf(Ys, dr.domElement);
function Po() {
  (requestAnimationFrame(Po),
    (ir.rotation.x += 0.01),
    (ir.rotation.y += 0.005),
    (ir.rotation.z += 0.01),
    pp.update(),
