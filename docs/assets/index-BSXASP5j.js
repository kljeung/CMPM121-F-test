...
class Wt {
  ...
  static getBarycoord(e, t, n, r, s) {
    (kt.subVectors(r, t), Qt.subVectors(n, t), Dr.subVectors(e, t));
    const a = kt.dot(kt),
      o = kt.dot(Qt),
      l = kt.dot(Dr),
      c = Qt.dot(Qt),
  ...
  static isFrontFacing(e, t, n, r) {
    return (kt.subVectors(n, t), Qt.subVectors(e, t), kt.cross(Qt).dot(r) < 0);
  }
  set(e, t, n) {
...
function Wf(i, e, t) {
  ...
  this.render = function (E, C, O) {
    ...
    for (let K = 0, q = E.length; K < q; K++) {
      ...
      if (
        ...
        const Se = this.type !== nn ? { minFilter: Dt, magFilter: Dt } : {};
      ...
      (H.isPointLightShadow !== !0 && this.type === nn && T(H, O),
        (H.needsUpdate = !1));
    }
  ...
  function A(E, C, O, S, v) {
    ...
    if (
      ...
      (E.castShadow || (E.receiveShadow && v === nn)) &&
...
function qf(i, e) {
  ...
  function R(w, ce) {
    w.side === rn ? de(i.CULL_FACE) : j(i.CULL_FACE);
    let ie = w.side === At;
    (ce && (ie = !ie),
      ze(ie),
...
function Yf(i, e, t, n, r, s, a) {
  ...
  const te = { [as]: i.REPEAT, [sn]: i.CLAMP_TO_EDGE, [os]: i.MIRRORED_REPEAT },
    se = {
      [Dt]: i.NEAREST,
    ...
    function Qs(_, L, N, z) {
      ...
      if (
        ...
        for (let Ye = 0, at = L.length; Ye < at; Ye++) {
          ...
          if (rt.side === rn && $e.layers.test(z.layers)) {
            const Rt = rt.side;
            ((rt.side = At),
              (rt.needsUpdate = !0),
              ea($e, N, z, Ee, rt, ke),
...
function Rp() {
  ...
  !no &&
    ...
    t < 1 &&
    ((no = !0),
    hn.bodies[0].mesh.material.color.setHex(65280),
    console.log("WIN!"));
}
function wp() {
  if (!hn) return;
  const i = hn.bodies[0].body,
    e = new bi.btVector3(0, 0, 0),
    t = 1;
  (zt.forward && e.op_add(new bi.btVector3(0, t, 0)),
    zt.backward && e.op_add(new bi.btVector3(0, -t, 0)),
    zt.left && e.op_add(new bi.btVector3(-t, 0, 0)),
    zt.right && e.op_add(new bi.btVector3(t, 0, 0)),
    i.applyCentralImpulse(e));
}
function Fo() {
  requestAnimationFrame(Fo);
  const i = Ap.getDelta();
  (hn && typeof hn.update == "function" && hn.update(i),
    Tp.update(),
    wp(),
    Rp(),
    xr.render(No, Zs));
